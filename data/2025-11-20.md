...
### [1] [Transformer Injectivity & Geometric Robustness - Analytic Margins and Bi-Lipschitz Uniformity of Sequence-Level Hidden States](https://arxiv.org/abs/2511.14808)
*Mikael von Strauss*

Main category: cs.LG

TL;DR: 在解码器自注意力 Transformer 的层级分析中，提出层级碰撞判别 Δ^ℓ 与注入层 U^ℓ，得到一个二分定理：要么在整个集合上非注入，要么在开集的层上每层都注入；若满足 mild 停止条件，沿固定 horizon 的平滑训练轨迹上泛化注入性持续存在；对称群 G 的存在性会把相关对象下投影至商空间 Θ/G，使注入性成为等效类的性质；并给出面向几何诊断的经验评估框架。


<details>
  <summary>Details</summary>
Motivation: 理解提示到最后一个隐藏状态之间的映射是否唯一，以及在实际训练和量化条件下的可逆性与鲁棒性， bridging 理论与经验。

Method: 为每层定义碰撞判别 Δ^ℓ ⊂ Θ 与注入层 U^ℓ = Θ ackslash Δ^ℓ，证明二分定理：要么模型在该集合上完全非单射，要么 U^ℓ 开集且稠密且每个 F^ℓ_θ 均可单射；在对优化器的非奇异性假设和初始化的绝对连续性下，沿平滑训练轨迹在固定视界内保持泛化注入性；处理对称群 G 的情形，将判定和结构下投影到商空间 Θ/G；并提出基于最近邻统计的分离边界和 co-Lipschitz 常数的几何诊断，用于 LLaMA-3、Qwen、GPT-2 的层间与量化实验。

Result: 得到 layer-wise 注入性二分定理、沿训练过程的注入性保持性、以及对对称性如何降维到 Θ/G 的结论；并提供分离边界和 co-Lipschitz 的可估计性结论。经验上，在全精度和 8-bit 情况下未观测到碰撞；4-bit 量化引入少量碰撞且显著降低 co-Lipschitz；从零开始训练的 GPT-2 的归一化指标在训练中保持稳定。综合而言，理论与实验共同指向在连续参数极化下 Transformer 表示具备普遍且持续的注入性；实际可逆性可通过简单几何诊断进行探测。

Conclusion: 理论与实证结果共同指向：Transformer 表示在连续参数极化下普遍且持续地具备注入性，但实际可逆性受量化等因素影响；可通过分离边界与 co-Lipschitz 诊断在实践中进行评估与研究。
...
### [2] [DEVAL: A Framework for Evaluating and Improving the Derivation Capability of Large Language Models](https://arxiv.org/abs/2511.14813)
...
### [3] [Dynamic Nested Hierarchies: Pioneering Self-Evolution in Machine Learning Architectures for Lifelong Intelligence](https://arxiv.org/abs/2511.14823)
...
### [4] [Empowering Multi-Turn Tool-Integrated Reasoning with Group Turn Policy Optimization](https://arxiv.org/abs/2511.14846)
...
### [5] [FinTRec: Transformer Based Unified Contextual Ads Targeting and Personalization for Financial Applications](https://arxiv.org/abs/2511.14865)
...
### [6] [Transformer-Guided Deep Reinforcement Learning for Optimal Takeoff Trajectory Design of an eVTOL Drone](https://arxiv.org/abs/2511.14887)
...
### [7] [Bringing Federated Learning to Space](https://arxiv.org/abs/2511.14889)
...
### [8] [It's LIT! Reliability-Optimized LLMs with Inspectable Tools](https://arxiv.org/abs/2511.14903)
...
### [9] [Structured Contrastive Learning for Interpretable Latent Representations](https://arxiv.org/abs/2511.14920)
...
### [15] [Oversampling techniques for predicting COVID-19 patient length of stay](https://arxiv.org/abs/2511.15048)
...
### [16] [Interpretable temporal fusion network of multi- and multi-class arrhythmia classification](https://arxiv.org/abs/2511.15062)
*Yun Kwan Kim*
...
### [17] [Deep Pathomic Learning Defines Prognostic Subtypes and Molecular Drivers in Colorectal Cancer](https://arxiv.org/abs/2511.15067)
...
### [18] [Sample-Adaptivity Tradeoff in On-Demand Sampling](https://arxiv.org/abs/2511.15507)
...
### [19] [Efficient RF Passive Components Modeling with Bayesian Online Learning and Uncertainty Aware Sampling](https://arxiv.org/abs/2511.15125)
...
### [20] [Novel sparse matrix algorithm expands the feasible size of a self-organizing map of the knowledge indexed by a database of peer-reviewed medical literature](https://arxiv.org/abs/2511.15136)
...
### [21] [From Solving to Verifying: A Unified Objective for Robust Reasoning in LLMs](https://arxiv.org/abs/2511.15137)
...
### [22] [Cross-Modal Consistency-Guided Active Learning for Affective BCI Systems](https://arxiv.org/abs/2511.15138)
...
### [23] [Complex variational autoencoders admit Kähler structure](https://arxiv.org/abs/2511.15172)
*Andrew Gracyk*
...
### [24] [FaultDiffusion: Few-Shot Fault Time Series Generation with Diffusion Model](https://arxiv.org/abs/2511.15174)
...
### [25] [Vehicle Routing Problems via Quantum Graph Attention Network Deep Reinforcement Learning](https://arxiv.org/abs/2511.15175)
...
### [26] [Masked Auto-Regressive Variational Acceleration: Fast Inference Makes Practical Reinforcement Learning](https://arxiv.org/abs/2511.15190)
...
### [27] [Reasoning in Diffusion Large Language Models is Concentrated in Dynamic Confusion Zones](https://arxiv.org/abs/2511.15208)
...
### [28] [D2D Power Allocation via Quantum Graph Neural Network](https://arxiv.org/abs/2511.15246)
...
### [30] [Optimized scheduling of electricity-heat cooperative system considering wind energy consumption and peak shaving and valley filling](https://arxiv.org/abs/2511.15250)
...
### [31] [PLATONT: Learning a Platonic Representation for Unified Network Tomography](https://arxiv.org/abs/2511.15251)
...
### [32] [GRPO-RM: Fine-Tuning Representation Models via GRPO-Driven Reinforcement Learning](https://arxiv.org/abs/2511.15256)
...
### [33] [SNAP: Low-Latency Test-Time Adaptation with Sparse Updates](https://arxiv.org/abs/2511.15276)
...
### [34] [Quant-Trim in Practice: Improved Cross-Platform Low-Bit Deployment on Edge NPUs](https://arxiv.org/abs/2511.15300)
...
### [35] [On the Internal Semantics of Time-Series Foundation Models](https://arxiv.org/abs/2511.15324)
...
### [37] [LaguerreNet: Advancing a Unified Solution for Heterophily and Over-smoothing with Adaptive Continuous Polynomials](https://arxiv.org/abs/2511.15328)
*Huseyin Goksu*
...
### [38] [Multi-layer Stack Ensembles for Time Series Forecasting](https://arxiv.org/abs/2511.15350)
...
### [39] [Cost-Aware Prediction (CAP): An LLM-Enhanced Machine Learning Pipeline and Decision Support System for Heart Failure Mortality Prediction](https://arxiv.org/abs/2511.15357)
...
### [40] [CID: Measuring Feature Importance Through Counterfactual Distributions](https://arxiv.org/abs/2511.15371)
...
### [41] [Parameter Importance-Driven Continual Learning for Foundation Models](https://arxiv.org/abs/2511.15375)
...
### [42] [EVA-Net: Interpretable Brain Age Prediction via Continuous Aging Prototypes from EEG](https://arxiv.org/abs/2511.15393)
...
### [43] [Proximal Approximate Inference in State-Space Models](https://arxiv.org/abs/2511.15409)
...
### [44] [Towards Understanding Layer Contributions in Tabular In-Context Learning Models](https://arxiv.org/abs/2511.15432)
...
### [45] [TSFM in-context learning for time-series classification of bearing-health status](https://arxiv.org/abs/2511.15447)
...
### [46] [FairEnergy: Contribution-Based Fairness meets Energy Efficiency in Federated Learning](https://arxiv.org/abs/2511.15454)
...
### [47] [NTK-Guided Implicit Neural Teaching](https://arxiv.org/abs/2511.15487)
...
### [48] [PCARNN-DCBF: Minimal-Intervention Geofence Enforcement for Ground Vehicles](https://arxiv.org/abs/2511.15522)
...
### [49] [Convex Clustering Redefined: Robust Learning with the Median of Means Estimator](https://arxiv.org/abs/2511.14784)
...
### [50] [Implicit Bias of the JKO Scheme](https://arxiv.org/abs/2511.14827)
...
### [51] [Latent space analysis and generalization to out-of-distribution data](https://arxiv.org/abs/2511.15010)
...
### [52] [Neural Networks Learn Generic Multi-Index Models Near Information-Theoretic Limit](https://arxiv.org/abs/2511.15120)
...
### [53] [Beyond Uncertainty Sets: Leveraging Optimal Transport to Extend Conformal Predictive Distribution to Multivariate Settings](https://arxiv.org/abs/2511.15146)
*Eugene Ndiaye*
...
### [54] [Robust Bayesian Optimisation with Unbounded Corruptions](https://arxiv.org/abs/2511.15315)
...
### [55] [Exponential Lasso: robust sparse penalization under heavy-tailed noise and outliers with exponential-type loss](https://arxiv.org/abs/2511.15332)
*The Tien Mai*
...
### [56] [Gini Score under Ties and Case Weights](https://arxiv.org/abs/2511.15446)
...
### [57] [A Physics Informed Machine Learning Framework for Optimal Sensor Placement and Parameter Estimation](https://arxiv.org/abs/2511.15543)
