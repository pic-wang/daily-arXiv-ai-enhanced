...
TL;DR: 两阶段的Co-Diffusion框架，用于药物-靶标亲和力预测，通过约束隐空间与扩散后验实现更强的泛化，特别在零样本/新分子和新蛋白家族上表现突出。


<details>
  <summary>Details</summary>
Motivation: 现有深度模型在严格冷启动条件下易出现表示塌陷，难以学习可转移的药效骨架和结合模式；需要一个能协调结构-序列模态并对抗噪声的学习框架。

Method: Stage I：通过有监督目标对齐药物与靶标嵌入，建立关注于结合景观的隐式流形；Stage II：引入模态特定的潜在扩散作为扰动-去噪正则化器，使模型从嘈杂表示中恢复一致的亲和语义，理论上最大化药物结构、蛋白序列和结合强度的变分下界。

Result: 在多项基准上显著优于现有方法，尤其在对未见骨架和新蛋白家族的零-shot泛化方面表现优越，表明在药物优先级筛选中的鲁棒性提升。

Conclusion: 提出的Co-Diffusion提供了一个稳健且可泛化的DTA预测框架，缓解重建-回归冲突并有明确的理论支撑，与实际化学空间探索具潜在价值。
...
### [2] [Efficient Approximation to Analytic and $L^p$ functions by Height-Augmented ReLU Networks](https://arxiv.org/abs/2603.11128)
*ZeYu Li,FengLei Fan,TieYong Zeng*

Main category: stat.ML

TL;DR: 3D neural networks drastically improve the efficiency of representing sawtooth functions, enabling stronger exponential approximation rates for analytic functions and a first non-asymptotic, high-order approximation for general L^p functions, which supports more parameter-efficient architectures.


<details>
  <summary>Details</summary>
Motivation: Two fundamental gaps in neural network approximation theory: (1) efficient representation of sawtooth-like functions that underpin approximations of analytic and L^p spaces, and (2) lack of quantitative non-asymptotic high-order approximation results for L^p functions. Addressing these could lead to more parameter-efficient networks and a deeper theoretical understanding.

Method: Introduce and analyze a three-dimensional network architecture. Prove substantially improved exponential approximation rates for several analytic function classes, while proposing a parameter-efficient network design. Derive, for the first time, a quantitative non-asymptotic high-order approximation for general L^p functions.

Result: The study yields (i) substantially improved exponential approximation rates for important analytic function classes, with a parameter-efficient network design; (ii) the first quantitative, non-asymptotic high-order approximation for general L^p functions.

Conclusion: The techniques advance the theoretical understanding of neural network approximation in key function spaces and provide a principled pathway for designing more parameter-efficient networks.
...
### [3] [Deep regression learning from dependent observations with minimum error entropy principle](https://arxiv.org/abs/2603.11138)
...
### [4] [Trustworthy predictive distributions for rare events via diagnostic transport maps](https://arxiv.org/abs/2603.11229)
...
### [5] [A Unified Latent Space Disentanglement VAE Framework with Robust Disentanglement Effectiveness Evaluation](https://arxiv.org/abs/2603.11242)
...
### [6] [RIE-Greedy: Regularization-Induced Exploration for Contextual Bandits](https://arxiv.org/abs/2603.11276)
...
### [7] [Worst-case low-rank approximations](https://arxiv.org/abs/2603.11304)
...
### [8] [Spatially Robust Inference with Predicted and Missing at Random Labels](https://arxiv.org/abs/2603.11368)
...
### [9] [Decomposing Observational Multiplicity in Decision Trees: Leaf and Structural Regret](https://arxiv.org/abs/2603.11701)
*Mustafa Cavus*
...
### [10] [Hypercomplex Widely Linear Processing: Fundamentals for Quaternion Machine Learning](https://arxiv.org/abs/2603.11835)
...
### [11] [Uncovering Locally Low-dimensional Structure in Networks by Locally Optimal Spectral Embedding](https://arxiv.org/abs/2603.11965)
...
### [12] [Wasserstein Gradient Flows for Batch Bayesian Optimal Experimental Design](https://arxiv.org/abs/2603.12102)
*Louis Sharrock*
...
### [15] [Interventional Time Series Priors for Causal Foundation Models](https://arxiv.org/abs/2603.11090)
...
### [16] [Fingerprinting Concepts in Data Streams with Supervised and Unsupervised Meta-Information](https://arxiv.org/abs/2603.11094)
...
### [17] [Graph Tokenization for Bridging Graphs and Transformers](https://arxiv.org/abs/2603.11099)
...
### [18] [Task-Conditioned Routing Signatures in Sparse Mixture-of-Experts Transformers](https://arxiv.org/abs/2603.11114)
...
### [19] [Learning Tree-Based Models with Gradient Descent](https://arxiv.org/abs/2603.11117)
*Sascha Marton*
...
### [20] [A Learning-Based Superposition Operator for Non-Renewal Arrival Processes in Queueing Networks](https://arxiv.org/abs/2603.11118)
*Eliran Sherzer*
...
### [21] [Group Resonance Network: Learnable Prototypes and Multi-Subject Resonance for EEG Emotion Recognition](https://arxiv.org/abs/2603.11119)
*Renwei Meng*
...
### [22] [Algorithmic Capture, Computational Complexity, and Inductive Bias of Infinite Transformers](https://arxiv.org/abs/2603.11161)
...
### [23] [High-resolution weather-guided surrogate modeling for data-efficient cross-location building energy prediction](https://arxiv.org/abs/2603.11121)
...
### [24] [On the Robustness of Langevin Dynamics to Score Function Error](https://arxiv.org/abs/2603.11319)
...
### [25] [Beyond Barren Plateaus: A Scalable Quantum Convolutional Architecture for High-Fidelity Image Classification](https://arxiv.org/abs/2603.11131)
...
### [26] [Exploiting Expertise of Non-Expert and Diverse Agents in Social Bandit Learning: A Free Energy Approach](https://arxiv.org/abs/2603.11757)
...
### [27] [Higher-Order Modular Attention: Fusing Pairwise and Triadic Interactions for Protein Sequences](https://arxiv.org/abs/2603.11133)
...
### [28] [A Further Efficient Algorithm with Best-of-Both-Worlds Guarantees for $m$-Set Semi-Bandit Problem](https://arxiv.org/abs/2603.11764)
...
### [29] [Scaling Reasoning Efficiently via Relaxed On-Policy Distillation](https://arxiv.org/abs/2603.11137)
...
### [30] [Language Generation with Replay: A Learning-Theoretic View of Model Collapse](https://arxiv.org/abs/2603.11784)
...
### [31] [H2LooP Spark Preview: Continual Pretraining of Large Language Models for Low-Level Embedded Systems Code](https://arxiv.org/abs/2603.11139)
...
### [32] [EnTransformer: A Deep Generative Transformer for Multivariate Probabilistic Forecasting](https://arxiv.org/abs/2603.11909)
...
### [33] [Procedural Fairness via Group Counterfactual Explanation](https://arxiv.org/abs/2603.11140)
...
### [34] [On-Average Stability of Multipass Preconditioned SGD and Effective Dimension](https://arxiv.org/abs/2603.11989)
...
### [38] [A Quantitative Characterization of Forgetting in Post-Training](https://arxiv.org/abs/2603.12163)
...
### [39] [Huntington Disease Automatic Speech Recognition with Biomarker Supervision](https://arxiv.org/abs/2603.11168)
...
### [40] [Bayesian Optimization of Partially Known Systems using Hybrid Models](https://arxiv.org/abs/2603.11199)
...
### [41] [Representation Finetuning for Continual Learning](https://arxiv.org/abs/2603.11201)
...
### [42] [Reference-Guided Machine Unlearning](https://arxiv.org/abs/2603.11210)
...
### [43] [Monitoring and Prediction of Mood in Elderly People during Daily Life Activities](https://arxiv.org/abs/2603.11230)
...
### [44] [Differentiable Thermodynamic Phase-Equilibria for Machine Learning](https://arxiv.org/abs/2603.11249)
...
### [45] [Beyond the Class Subspace: Teacher-Guided Training for Reliable Out-of-Distribution Detection in Single-Domain Models](https://arxiv.org/abs/2603.11269)
...
### [46] [Duration Aware Scheduling for ASR Serving Under Workload Drift](https://arxiv.org/abs/2603.11273)
...
### [47] [Client-Conditional Federated Learning via Local Training Data Statistics](https://arxiv.org/abs/2603.11307)
*Rickard Brännvall*
...
### [48] [Heavy-Tailed Principle Component Analysis](https://arxiv.org/abs/2603.11308)
...
### [59] [A Stable Neural Statistical Dependence Estimator for Autoencoder Feature Analysis](https://arxiv.org/abs/2603.11428)
...
### [60] [ZTab: Domain-based Zero-shot Annotation for Table Columns](https://arxiv.org/abs/2603.11436)
...
### [61] [UniHetCO: A Unified Heterogeneous Representation for Multi-Problem Learning in Unsupervised Neural Combinatorial Optimization](https://arxiv.org/abs/2603.11456)
...
### [62] [Bridging Discrete Marks and Continuous Dynamics: Dual-Path Cross-Interaction for Marked Temporal Point Processes](https://arxiv.org/abs/2603.11462)
...
### [63] [Slack More, Predict Better: Proximal Relaxation for Probabilistic Latent Variable Model-based Soft Sensors](https://arxiv.org/abs/2603.11473)
...
### [64] [Deep Learning Network-Temporal Models For Traffic Prediction](https://arxiv.org/abs/2603.11475)
...
### [65] [Leveraging Phytolith Research using Artificial Intelligence](https://arxiv.org/abs/2603.11476)
...
### [66] [Grammar of the Wave: Towards Explainable Multivariate Time Series Event Detection via Neuro-Symbolic VLM Agents](https://arxiv.org/abs/2603.11479)
...
### [67] [Attention Sinks Are Provably Necessary in Softmax Transformers: Evidence from Trigger-Conditional Tasks](https://arxiv.org/abs/2603.11487)
*Yuval Ran-Milo*
...
### [68] [KEPo: Knowledge Evolution Poison on Graph-based Retrieval-Augmented Generation](https://arxiv.org/abs/2603.11501)
...
### [69] [Sharpness-Aware Minimization for Generalized Embedding Learning in Federated Recommendation](https://arxiv.org/abs/2603.11503)
...
### [70] [LongFlow: Efficient KV Cache Compression for Reasoning M](https://arxiv.org/abs/2603.11504)
...
### [71] [CFD-HAR: User-controllable Privacy through Conditional Feature Disentanglement](https://arxiv.org/abs/2603.11526)
...
### [72] [Multi-Task Anti-Causal Learning for Reconstructing Urban Events from Residents' Reports](https://arxiv.org/abs/2603.11546)
...
### [73] [CAETC: Causal Autoencoding and Treatment Conditioning for Counterfactual Estimation over Time](https://arxiv.org/abs/2603.11565)
...
### [74] [Survival Meets Classification: A Novel Framework for Early Risk Prediction Models of Chronic Diseases](https://arxiv.org/abs/2603.11598)
...
### [75] [Hybrid Energy-Aware Reward Shaping: A Unified Lightweight Physics-Guided Methodology for Policy Optimization](https://arxiv.org/abs/2603.11600)
...
### [76] [AutoScout: Structured Optimization for Automating ML System Configuration](https://arxiv.org/abs/2603.11603)
...
### [77] [Fractional Rotation, Full Potential? Investigating Performance and Convergence of Partial RoPE](https://arxiv.org/abs/2603.11611)
...
### [78] [Personalized Federated Learning via Gaussian Generative Modeling](https://arxiv.org/abs/2603.11620)
*Peng Hu,Jianwei Ma*
...
### [79] [Simple Recipe Works: Vision-Language-Action Models are Natural Continual Learners with Reinforcement Learning](https://arxiv.org/abs/2603.11653)
...
### [80] [Context-dependent manifold learning: A neuromodulated constrained autoencoder approach](https://arxiv.org/abs/2603.11673)
...
### [81] [Entropy-Preserving Reinforcement Learning](https://arxiv.org/abs/2603.11682)
...
### [82] [EvoFlows: Evolutionary Edit-Based Flow-Matching for Protein Engineering](https://arxiv.org/abs/2603.11703)
...
### [83] [Mitigating the Multiplicity Burden: The Role of Calibration in Reducing Predictive Multiplicity of Classifiers](https://arxiv.org/abs/2603.11750)
*Mustafa Cavus*
...
### [84] [Disentangled Representation Learning through Unsupervised Symmetry Group Discovery](https://arxiv.org/abs/2603.11790)
...
### [85] [Exponential-Family Membership Inference: From LiRA and RMIA to BaVarIA](https://arxiv.org/abs/2603.11799)
*Rickard Brännvall*
...
### [86] [Inverse Neural Operator for ODE Parameter Optimization](https://arxiv.org/abs/2603.11854)
...
### [87] [On the Role of Reversible Instance Normalization](https://arxiv.org/abs/2603.11869)
...
### [88] [FlexRec: Adapting LLM-based Recommenders for Flexible Needs via Reinforcement Learning](https://arxiv.org/abs/2603.11901)
...
### [89] [Causal Representation Learning with Optimal Compression under Complex Treatments](https://arxiv.org/abs/2603.11907)
...
### [90] [Chem4DLLM: 4D Multimodal LLMs for Chemical Dynamics Understanding](https://arxiv.org/abs/2603.11924)
...
### [91] [MobileKernelBench: Can LLMs Write Efficient Kernels for Mobile Devices?](https://arxiv.org/abs/2603.11935)
...
### [92] [Exhaustive Circuit Mapping of a Single-Cell Foundation Model Reveals Massive Redundancy, Heavy-Tailed Hub Architecture, and Layer-Dependent Differentiation Control](https://arxiv.org/abs/2603.11940)
*Ihor Kendiukhov*
...
### [93] [Causal Matrix Completion under Multiple Treatments via Mixed Synthetic Nearest Neighbors](https://arxiv.org/abs/2603.11942)
...
### [94] [Effective Resistance Rewiring: A Simple Topological Correction for Over-Squashing](https://arxiv.org/abs/2603.11944)
...
### [96] [Statistical and structural identifiability in representation learning](https://arxiv.org/abs/2603.11970)
...
### [97] [Topological DeepONets and a generalization of the Chen-Chen operator approximation theorem](https://arxiv.org/abs/2603.11972)
*Vugar Ismailov*
...
### [98] [Deep Learning-Based Metamodeling of Nonlinear Stochastic Dynamic Systems under Parametric and Predictive Uncertainty](https://arxiv.org/abs/2603.12012)
...
### [99] [Flowcean - Model Learning for Cyber-Physical Systems](https://arxiv.org/abs/2603.12015)
...
### [100] [Efficient Generative Modeling with Unitary Matrix Product States Using Riemannian Optimization](https://arxiv.org/abs/2603.12026)
...
### [101] [Frequentist Consistency of Prior-Data Fitted Networks for Causal Inference](https://arxiv.org/abs/2603.12037)
...
### [102] [Slow-Fast Inference: Training-Free Inference Acceleration via Within-Sentence Support Stability](https://arxiv.org/abs/2603.12038)
...
### [103] [A Multi-Label Temporal Convolutional Framework for Transcription Factor Binding Characterization](https://arxiv.org/abs/2603.12073)
...
### [104] [Cross-Domain Policy Optimization via Bellman Consistency and Hybrid Critics](https://arxiv.org/abs/2603.12087)
...
### [105] [Resource-Efficient Iterative LLM-Based NAS with Feedback Memory](https://arxiv.org/abs/2603.12091)
...
### [107] [Cornserve: A Distributed Serving System for Any-to-Any Multimodal Models](https://arxiv.org/abs/2603.12118)
...
### [108] [Automatic Generation of High-Performance RL Environments](https://arxiv.org/abs/2603.12145)
...
### [109] [IsoCompute Playbook: Optimally Scaling Sampling Compute for LLM RL](https://arxiv.org/abs/2603.12151)
...
### [111] [Security Considerations for Artificial Intelligence Agents](https://arxiv.org/abs/2603.12230)
...
### [112] [Temporal Straightening for Latent Planning](https://arxiv.org/abs/2603.12231)
...
### [113] [STAMP: Selective Task-Aware Mechanism for Text Privacy](https://arxiv.org/abs/2603.12237)
...
### [114] [Separable neural architectures as a primitive for unified predictive and generative intelligence](https://arxiv.org/abs/2603.12244)
