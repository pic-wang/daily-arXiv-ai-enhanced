...
### [1] [SUPN: Shallow Universal Polynomial Networks](https://arxiv.org/abs/2511.21414)
...
### [2] [Prototype-Guided Non-Exemplar Continual Learning for Cross-subject EEG Decoding](https://arxiv.org/abs/2511.20696)
...
### [3] [On the Role of Hidden States of Modern Hopfield Network in Transformer](https://arxiv.org/abs/2511.20698)
...
### [4] [Post-Pruning Accuracy Recovery via Data-Free Knowledge Distillation](https://arxiv.org/abs/2511.20702)
...
### [5] [Pretraining Transformer-Based Models on Diffusion-Generated Synthetic Graphs for Alzheimer's Disease Prediction](https://arxiv.org/abs/2511.20704)
...
### [6] [Solving Diffusion Inverse Problems with Restart Posterior Sampling](https://arxiv.org/abs/2511.20705)
...
### [7] [Active Slice Discovery in Large Language Models](https://arxiv.org/abs/2511.20713)
...
### [8] [Selecting Belief-State Approximations in Simulators with Latent States](https://arxiv.org/abs/2511.20870)
*Nan Jiang*
...
### [9] [ST-PPO: Stabilized Off-Policy Proximal Policy Optimization for Multi-Turn Agents Training](https://arxiv.org/abs/2511.20718)
...
### [10] [Probabilistic Hash Embeddings for Online Learning of Categorical Features](https://arxiv.org/abs/2511.20893)
...
### [11] [Gradient Descent Algorithm Survey](https://arxiv.org/abs/2511.20725)
...
### [12] [Operationalizing Quantized Disentanglement](https://arxiv.org/abs/2511.20927)
...
### [13] [Estimating Ising Models in Total Variation Distance](https://arxiv.org/abs/2511.21008)
...
### [14] [Spatio-Temporal Trajectory Foundation Model - Recent Advances and Future Directions](https://arxiv.org/abs/2511.20729)
...
### [15] [Breaking the Safety-Capability Tradeoff: Reinforcement Learning with Verifiable Rewards Maintains Safety Guardrails in LLMs](https://arxiv.org/abs/2511.21050)
...
TL;DR: 在KL约束优化下使用RLVR可同时提升推理能力与维持或提升安全性，挑战了普遍存在的安全-能力权衡假设。


<details>
  <summary>Details</summary>
Motivation: 解决大语言模型微调时常见的安全性与任务能力之间的权衡问题，探索可验证奖励的强化学习（RLVR）是否能同时提升能力和安全性。

Method: 理论分析：在KL约束下推导安全漂移的上界，并给出可消除安全降级的充要条件；经验分析：在五个对抗性安全基准上进行大规模实验，比较不同优化算法、模型规模与任务域的影响，进行系统的消融研究。

Result: 实验结果表明，RLVR在提高推理能力的同时，能够维持甚至提升安全防护水平，打破了“安全与能力不可兼得”的普遍认知，且在不同模型规模和任务领域中具有鲁棒性。

Conclusion: 基于对KL约束下的RLVR训练方法，可以同时实现高性能与安全性，为推理能力强的LLM的安全部署提供可行路径。
...
### [16] [CHiQPM: Calibrated Hierarchical Interpretable Image Classification](https://arxiv.org/abs/2511.20779)
*Thomas Norrenbrock,Timo Kaiser,Sovan Biswas,Neslihan Kose,Ramesh Manuvinakurike,Bodo Rosenhahn*

Main category: cs.LG

TL;DR: Calibrated Hierarchical QPM (CHiQPM) 提供全局解释性与局部解释性的一致框架，通过分层解释接近人类推理，并与可解释的 conformal prediction 集成；在保持可解释性的同时实现高准确性。


<details>
  <summary>Details</summary>
Motivation: 在安全关键领域需要可信的全局解释，同时提供细粒度的局部解释以支持人类专家的推理，并引入可解释的 conformal prediction 以输出经过校准的预测集合。

Method: 提出 CHiQPM 框架：1) 通过对多数类别进行对比性解释来提升全局可解释性；2) 构建分层解释，模拟人类推理并可遍历；3) 集成内置的可解释 conformal prediction 以提供校准的预测集合；4) 提供能产生一致且可解释的预测集合的层级输出；5) 在点预测上实现竞争性准确率，达到接近非可解释模型的水平。

Result: 综合评估显示，CHiQPM 作为点预测器达到最先进的准确率，并保持为非解释模型的 99% 的准确率；可校准的集合预测与其他 CP 方法具有竞争力，并在分层解释中给出一致的可解释集合预测。

Conclusion: 在不牺牲整体准确性的前提下实现了更高的可解释性，CHiQPM 促进了人机互补的应用前景，通过全局与局部解释并行提供可解释的预测集合，适用于需要可信解释的场景。
...
### [17] [G-Net: A Provably Easy Construction of High-Accuracy Random Binary Neural Networks](https://arxiv.org/abs/2511.21063)
...
### [18] [Physics Steering: Causal Control of Cross-Domain Concepts in a Physics Foundation Model](https://arxiv.org/abs/2511.20798)
*Rio Alexa Fear,Payel Mukhopadhyay,Michael McCabe,Alberto Bietti,Miles Cranmer*

Main category: cs.LG

TL;DR: 把机理可解释性扩展到物理导向的基础模型，提取不同物理态下的激活向量差异作为概念方向，通过注入这些方向来实现对仿真输出的因果控制，表明科学基础模型具备广义的物理原理表征。


<details>
  <summary>Details</summary>
Motivation: 回答“这种现象是否仅限于语言/视觉等结构化数据的模型，还是普遍存在于基础模型中？”并探索是否可通过学习的内部表征促进科学发现。

Method: 在物理基础模型中，针对不同物理 regime 的仿真数据，提取前向传播中的激活向量，计算两种 regime 间的 delta 张量作为概念方向；将这些概念方向注入推断过程以操控模型输出，从而实现对物理行为的因果控制。

Result: 注入概念方向后，模型输出可被定向改变，产生或去除特定物理特征，证明对物理行为的因果控制；结果支持科学基础模型学习到广义的物理原理表征，而非仅仅表面的相关性。

Conclusion: 显示科学基础模型具备对物理原理的泛化表征能力，为理解与控制此类模型、以及推动 AI 辅助的科学发现提供新路径。
...
### [19] [How to Correctly Report LLM-as-a-Judge Evaluations](https://arxiv.org/abs/2511.21140)
...
### [20] [Conformal Safety Monitoring for Flight Testing: A Case Study in Data-Driven Safety Learning](https://arxiv.org/abs/2511.20811)
...
### [21] [Effects of Initialization Biases on Deep Neural Network Training Dynamics](https://arxiv.org/abs/2511.20826)
...
### [22] [Autoregressive Surrogate Modeling of the Solar Wind with Spherical Fourier Neural Operator](https://arxiv.org/abs/2511.20830)
...
### [23] [Primal: A Unified Deterministic Framework for Quasi-Orthogonal Hashing and Manifold Learning](https://arxiv.org/abs/2511.20839)
*Vladimer Khasia*
...
### [24] [Pre-train to Gain: Robust Learning Without Clean Labels](https://arxiv.org/abs/2511.20844)
*David Szczecina,Nicholas Pellegrino,Paul Fieguth*

Main category: cs.LG

TL;DR: Self-supervised pre-training (e.g., SimCLR, Barlow Twins) before supervised training on noisy labels improves robustness to label noise and enhances downstream label-error detection; at low noise levels it matches ImageNet pretraining, and at high noise it substantially outperforms it.


<details>
  <summary>Details</summary>
Motivation: Label noise causes overfitting and degrades generalization, and many methods rely on clean data subsets. Self-supervised learning does not require labels and can learn robust representations that transfer to noisy supervised tasks.

Method: Pre-train a backbone with self-supervised learning on unlabeled data (SimCLR, Barlow Twins), then train supervised on a noisy CIFAR-10/100 dataset with synthetic and real-world noise. Compare to baselines (supervised from scratch and ImageNet-pretrained models). Evaluate classification accuracy and downstream label-error detection (F1, balanced accuracy).

Result: Across all noise rates, SSL pre-training consistently improves classification accuracy and enhances downstream label-error detection. The accuracy improvement and error-detection gains widen as noise rate increases, indicating stronger robustness. At low noise, SSL-pretrained models achieve comparable performance to ImageNet-pretrained models; at high noise, they substantially outperform ImageNet pretraining.

Conclusion: Self-supervised pre-training provides a robust, label-efficient way to improve learning with noisy labels, reducing dependence on clean data and yielding better downstream performance and error detection, especially under heavy label noise.
...
### [25] [Representation Integrity in Temporal Graph Learning Methods](https://arxiv.org/abs/2511.20873)
*Elahe Kooshafar*
...
### [26] [Evolved SampleWeights for Bias Mitigation: Effectiveness Depends on Optimization Objectives](https://arxiv.org/abs/2511.20909)
*Anil K. Saini,Jose Guadalupe Hernandez,Emily F. Wong,Debanshi Misra,Jason H. Moore*

Main category: cs.LG

TL;DR: 通过遗传算法演化样本权重以在公平性和预测性能之间取得权衡，优于基于数据集特征的权重或等权重，在大多数数据集上取得更优的权衡，且效果受优化目标选择影响，使用准确率和人口统计平等差异的组合可获得最多数据集的显著改进。


<details>
  <summary>Details</summary>
Motivation: 现实世界数据中的偏见会导致对边缘群体有害的预测。通过重新加权训练样本以缓解偏见是一个常用方法。本研究比较了三种权重生成策略并评估它们在公平性与预测性能之间的权衡。

Method: 比较三种权重策略：遗传算法演化的样本权重；仅基于数据集特征的权重；对所有样本赋予相同权重。使用两类预测指标（准确率、AUC）和两类公平性指标（人口统计平等差异、子群假阴性公平性）作为GA的优化目标。对11个公开数据集（其中2个医疗数据集）进行评估，比较不同策略的模型在公平性和预测性能上的权衡。

Result: 演化权重的模型通常能在公平性与预测性能之间取得更优的权衡，优于其他权重方法；但收益的大小强烈依赖于所选的优化目标。以准确率和人口统计平等差异为优化目标时，能够在大多数数据集上获得显著改进的机会更多。

Conclusion: 基于GA的样本权重演化是一种有前景的方法来平衡公平性与预测性能，但其效益取决于所选择的优化目标。基于数据集特征的权重或等权重的策略相对较弱，关键在于目标函数的选择。
...
### [27] [Exploring Time-Step Size in Reinforcement Learning for Sepsis Treatment](https://arxiv.org/abs/2511.20913)
...
### [28] [Semantic Superiority vs. Forensic Efficiency: A Comparative Analysis of Deep Learning and Psycholinguistics for Business Email Compromise Detection](https://arxiv.org/abs/2511.20944)
*Yaw Osei Adjei*
...
### [29] [Dataset Poisoning Attacks on Behavioral Cloning Policies](https://arxiv.org/abs/2511.20992)
...
### [30] [Subgoal Graph-Augmented Planning for LLM-Guided Open-World Reinforcement Learning](https://arxiv.org/abs/2511.20993)
*Shanwei Fan*
...
### [31] [FANoise: Singular Value-Adaptive Noise Modulation for Robust Multimodal Representation Learning](https://arxiv.org/abs/2511.20997)
...
### [32] [ChatGpt Content detection: A new approach using xlm-roberta alignment](https://arxiv.org/abs/2511.21009)
...
### [33] [Staggered Environment Resets Improve Massively Parallel On-Policy Reinforcement Learning](https://arxiv.org/abs/2511.21011)
...
### [38] [FedAPA: Federated Learning with Adaptive Prototype Aggregation Toward Heterogeneous Wi-Fi CSI-based Crowd Counting](https://arxiv.org/abs/2511.21048)
...
### [39] [Efficient Diffusion Planning with Temporal Diffusion](https://arxiv.org/abs/2511.21054)
...
### [40] [A Unified Understanding of Offline Data Selection and Online Self-refining Generation for Post-training LLMs](https://arxiv.org/abs/2511.21056)
...
### [41] [Aligning LLMs with Biomedical Knowledge using Balanced Fine-Tuning](https://arxiv.org/abs/2511.21075)
...
### [42] [Deceptron: Learned Local Inverses for Fast and Stable Physics Inversion](https://arxiv.org/abs/2511.21076)
...
### [43] [MNM : Multi-level Neuroimaging Meta-analysis with Hyperbolic Brain-Text Representations](https://arxiv.org/abs/2511.21092)
...
### [44] [Generative Early Stage Ranking](https://arxiv.org/abs/2511.21095)
...
### [45] [From Bits to Rounds: Parallel Decoding with Exploration for Diffusion Language Models](https://arxiv.org/abs/2511.21103)
...
### [46] [BRIDGE: Building Representations In Domain Guided Program Verification](https://arxiv.org/abs/2511.21104)
...
### [47] [Dynamic Stratified Contrastive Learning with Upstream Augmentation for MILP Branching](https://arxiv.org/abs/2511.21107)
...
### [48] [Interpretable Fair Clustering](https://arxiv.org/abs/2511.21109)
...
### [49] [Trustless Federated Learning at Edge-Scale: A Compositional Architecture for Decentralized, Verifiable, and Incentive-Aligned Coordination](https://arxiv.org/abs/2511.21118)
...
### [50] [Learning Cell-Aware Hierarchical Multi-Modal Representations for Robust Molecular Modeling](https://arxiv.org/abs/2511.21120)
...
### [51] [I-GLIDE: Input Groups for Latent Health Indicators in Degradation Estimation](https://arxiv.org/abs/2511.21208)
...
### [52] [Robust Gene Prioritization via Fast-mRMR Feature Selection in high-dimensional omics data](https://arxiv.org/abs/2511.21211)
...
### [53] [A Physics-Informed U-net-LSTM Network for Data-Driven Seismic Response Modeling of Structures](https://arxiv.org/abs/2511.21276)
...
### [54] [Sawtooth Sampling for Time Series Denoising Diffusion Implicit Models](https://arxiv.org/abs/2511.21320)
...
### [55] [TSGM: Regular and Irregular Time-series Generation using Score-based Generative Models](https://arxiv.org/abs/2511.21335)
...
### [56] [Masks Can Be Distracting: On Context Comprehension in Diffusion Language Models](https://arxiv.org/abs/2511.21338)
...
### [57] [Best Practices for Machine Learning Experimentation in Scientific Applications](https://arxiv.org/abs/2511.21354)
...
### [58] [Hybrid-AIRL: Enhancing Inverse Reinforcement Learning with Supervised Expert Guidance](https://arxiv.org/abs/2511.21356)
*Bram Silue,Santiago Amaya-Corredor,Patrick Mannion,Lander Willem,Pieter Libin*

Main category: cs.LG

TL;DR: Hybrid-AIRL (H-AIRL) extends AIRL with supervised expert loss and stochastic regularization to tackle sparse-reward, imperfect-information tasks like Heads-Up Limit Hold'em poker; it yields better sample efficiency and stability than AIRL on Gymnasium benchmarks and HULHE.


<details>
  <summary>Details</summary>
Motivation: Address the difficulty of inferring informative dense reward functions in complex, uncertain environments where AIRL struggles due to sparse, delayed rewards and imperfect information.

Method: Augment AIRL with a supervised loss derived from expert demonstrations and introduce a stochastic regularization mechanism to stabilize training, forming the Hybrid-AIRL (H-AIRL) framework; evaluate on selected Gymnasium benchmarks and HULHE, with reward-function visualization.

Result: H-AIRL outperforms AIRL in terms of sample efficiency and training stability across tested tasks; reward-function analysis provides deeper insights into the learning dynamics.

Conclusion: Incorporating supervised signals into inverse RL can improve performance and stability in challenging, real-world domains, making H-AIRL a promising approach for tasks with sparse rewards and high uncertainty.
...
### [60] [BanglaMM-Disaster: A Multimodal Transformer-Based Deep Learning Framework for Multiclass Disaster Classification in Bangla](https://arxiv.org/abs/2511.21364)
...
### [64] [Subjective Depth and Timescale Transformers: Learning Where and When to Compute](https://arxiv.org/abs/2511.21408)
...
### [65] [Ensemble Performance Through the Lens of Linear Independence of Classifier Votes in Data Streams](https://arxiv.org/abs/2511.21465)
...
### [66] [Mean-Field Limits for Two-Layer Neural Networks Trained with Consensus-Based Optimization](https://arxiv.org/abs/2511.21466)
...
### [67] [Lost in Time? A Meta-Learning Framework for Time-Shift-Tolerant Physiological Signal Transformation](https://arxiv.org/abs/2511.21500)
...
### [68] [IntAttention: A Fully Integer Attention Pipeline for Efficient Edge Inference](https://arxiv.org/abs/2511.21513)
...
### [69] [Mechanistic Interpretability for Transformer-based Time Series Classification](https://arxiv.org/abs/2511.21514)
...
### [70] [Predictive Safety Shield for Dyna-Q Reinforcement Learning](https://arxiv.org/abs/2511.21531)
...
### [71] [Context-Specific Causal Graph Discovery with Unobserved Contexts: Non-Stationarity, Regimes and Spatio-Temporal Patterns](https://arxiv.org/abs/2511.21537)
...
### [72] [Computing Strategic Responses to Non-Linear Classifiers](https://arxiv.org/abs/2511.21560)
...
### [73] [Machine Learning Approaches to Clinical Risk Prediction: Multi-Scale Temporal Alignment in Electronic Health Records](https://arxiv.org/abs/2511.21561)
...
### [74] [A decoupled alignment kernel for peptide membrane permeability predictions](https://arxiv.org/abs/2511.21566)
...
### [75] [An AI-Enabled Hybrid Cyber-Physical Framework for Adaptive Control in Smart Grids](https://arxiv.org/abs/2511.21590)
...
### [76] [When Features Beat Noise: A Feature Selection Technique Through Noise-Based Hypothesis Testing](https://arxiv.org/abs/2511.20851)
*Mousam Sinha,Tirtha Sarathi Ghosh,Ridam Pal*

Main category: stat.ML

TL;DR: 提出一种新的特征选择方法，通过引入多个随机噪声特征并以噪声特征中的最大重要性值作为阈值，结合非参数自助/bootstrap 假设检验，提供理论基础并在模拟与真实数据中优于 Boruta、RFE、Knockoff 等方法。


<details>
  <summary>Details</summary>
Motivation: 在高维数据中，现有特征选择方法存在显著局限性，如计算成本高、缺乏明确的统计停止准则、以及对重要性分数的显著性评估不健全。基于选心得到的阈值通常缺乏理论支撑，传统的噪声对比策略缺乏严格证据。

Method: 引入多个随机噪声特征，比较每个特征的重要性与噪声特征中的最大重要性值；采用基于非参数自助法的假设检验来建立显著性判定，提供理论化的算法设计原则。通过统计推导论证设计原则，并在受控统计设定的模拟数据上评估，与 Boruta 与 Knockoff 等方法对比。

Result: 在受控模拟数据中，方法对有意义信号的恢复表现持续优于 Boruta 与 Knockoff 基于方法；在多组真实数据集上，该方法的特征选择性能超过 Boruta、RFE、Extra Trees 等方法，展现出鲁棒性和实用性。

Conclusion: 该方法提供一个基于统计假设检验的、以噪声对比为基准的特征选择框架，能够更可靠地筛选信息丰富的预测变量，从而提升推断可靠性、预测性能与计算效率。
...
### [77] [Deep Learning as a Convex Paradigm of Computation: Minimizing Circuit Size with ResNets](https://arxiv.org/abs/2511.20888)
*Arthur Jacot*

Main category: stat.ML

TL;DR: DNNs實作了一個計算性的最小化說明：透過HTMC凸性與ResNet參數範數的連結，將 ResNet 轉化為近似最小電路大小的模型，解釋其在各種任務上的成功。


<details>
  <summary>Details</summary>
Motivation: 解釋深度學習在廣泛任務上的出色性能，通過結合函數複雜度與神經網路參數的規範化度量，建立一個計算Occam's razor 的框架。

Method: 定義在 ε-逼近下、以二進制電路表示的函數集，在 γ>2 的條件下形成凸集，進而定義 HTMCnorm；定義 ResNet 參數的加權 L1 範數以誘導函數的 ResNetnorm；給出 HTMCnorm 與 ResNetnorm 的幾乎匹配的 sandwich bound，並說明:minimizing ResNetnorm 等價於尋找近乎最小節點的電路。

Result: HTMCnorm 與 ResNetnorm 之間存在幾乎匹配的界（sandwich bound），使得最小化 ResNetnorm 接近尋找具有最少節點的電路；這使 ResNet 成為以HTMC機制計算實數函數的替代模型。

Conclusion: ResNet 及其參數規範提供了一個理論橋梁，使深度學習的成功可被視為對抗過於複雜模型的一種計算性Occam's razor，特別是在 HTMC 的凸性區間。
...
### [78] [Geometric Calibration and Neutral Zones for Uncertainty-Aware Multi-Class Classification](https://arxiv.org/abs/2511.20960)
*Soumojit Das,Nairanjana Dasgupta,Prashanta Dutta*

Main category: stat.ML

TL;DR: 提出一个基于信息几何的后验校准框架：在Fisher–Rao度量下将概率向量视为概率简单形上的点，得到ALR校准映射，二分类退化回Platt标定，多分类则提供理论上更自然的推广；另定义基于Fisher–Rao距离的几何可靠性分数与中性区用于不确定预测的理性推迟。


<details>
  <summary>Details</summary>
Motivation: 现有分类模型在不确定性时可能悄然出错，需要一个有几何与统计理论支撑的后验校准与结果拒绝框架，以提高决策的可验证性与鲁棒性，尤其希望将多分类情形自然地推广到一个一致的几何框架中。

Method: 将概率向量视为概率简单形上的点，使用Fisher–Rao度量建立几何校准映射，得到Additive Log-Ratio(ALR)校准；证明在二分类情形下它等价于Platt标定；构建基于Fisher–Rao距离的可靠性分数并设定中性区以实现对不确定预测的理性拒绝；给出M估计理论下的一致性（O_p(n^{-1/2})，定理1）以及可靠性分数的紧界与子高斯参数（定理2）；在AAV分类数据集上进行验证，展示两阶段框架（先校准再基于可靠性分数拒绝）能够捕获72.5%的错误并拒绝34.5%的样本。

Result: 理论上提供了二分类时等同于Platt标定的等价性以及对多分类的自然扩展；给出一致性与紧致的概率界；两阶段框架在实际数据集上实现了显著的错误捕获与合理的拒绝比例，且强调几何校准的贡献在于理论基础而非超越简单方法的 empirical 优势。

Conclusion: 将信息几何与统计学习结合，给出对概率输出的后验校准与不确定样本的理性推迟的形式化框架及理论保证，适用于需要严格验证的应用场景。未来工作可能包括对更广泛度量的推广、与具体任务的计算效率优化，以及在更多数据集上的验证。
...
### [79] [Nonconvex Penalized LAD Estimation in Partial Linear Models with DNNs: Asymptotic Analysis and Proximal Algorithms](https://arxiv.org/abs/2511.21115)
...
### [80] [Maxitive Donsker-Varadhan Formulation for Possibilistic Variational Inference](https://arxiv.org/abs/2511.21223)
...
### [81] [Phase Transition for Stochastic Block Model with more than $\sqrt{n}$ Communities (II)](https://arxiv.org/abs/2511.21526)
