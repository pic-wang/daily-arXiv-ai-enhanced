...
### [2] [From Adam to Adam-Like Lagrangians: Second-Order Nonlocal Dynamics](https://arxiv.org/abs/2602.09101)
*Carlos Heredia*
...
### [3] [Spectral Disentanglement and Enhancement: A Dual-domain Contrastive Framework for Representation Learning](https://arxiv.org/abs/2602.09066)
...
### [4] [Stabilizing Physics-Informed Consistency Models via Structure-Preserving Training](https://arxiv.org/abs/2602.09303)
...
### [6] [Adaptive recurrent flow map operator learning for reaction diffusion dynamics](https://arxiv.org/abs/2602.09487)
*Huseyin Tunc*
...
### [7] [Patient foundation model for risk stratification in low-risk overweight patients](https://arxiv.org/abs/2602.09079)
...
### [8] [Learning to Discover Iterative Spectral Algorithms](https://arxiv.org/abs/2602.09530)
...
### [9] [Looping Back to Move Forward: Recursive Transformers for Efficient and Flexible Large Multimodal Models](https://arxiv.org/abs/2602.09080)
...
### [10] [Physics-informed diffusion models in spectral space](https://arxiv.org/abs/2602.09708)
...
### [11] [Distributed Hybrid Parallelism for Large Language Models: Comparative Study and System Design Guide](https://arxiv.org/abs/2602.09109)
...
### [12] [Fair Feature Importance Scores via Feature Occlusion and Permutation](https://arxiv.org/abs/2602.09196)
...
### [14] [Clarifying Shampoo: Adapting Spectral Descent to Stochasticity and the Parameter Trajectory](https://arxiv.org/abs/2602.09314)
...
### [15] [Importance inversion transfer identifies shared principles for cross-domain learning](https://arxiv.org/abs/2602.09116)
*Daniele Caligiore*
...
### [16] [SnareNet: Flexible Repair Layers for Neural Networks with Hard Constraints](https://arxiv.org/abs/2602.09317)
...
### [17] [SpinCastML an Open Decision-Making Application for Inverse Design of Electrospinning Manufacturing: A Machine Learning, Optimal Sampling and Inverse Monte Carlo Approach](https://arxiv.org/abs/2602.09120)
...
### [18] [Taming the Monster Every Context: Complexity Measure and Unified Framework for Offline-Oracle Efficient Contextual Bandits](https://arxiv.org/abs/2602.09456)
...
### [19] [Epistemic Throughput: Fundamental Limits of Attention-Constrained Inference](https://arxiv.org/abs/2602.09127)
*Lei You*
...
### [20] [Blind denoising diffusion models and the blessings of dimensionality](https://arxiv.org/abs/2602.09639)
...
### [21] [Counterfactual Maps: What They Are and How to Find Them](https://arxiv.org/abs/2602.09128)
...
### [22] [Causal Identification in Multi-Task Demand Learning with Confounding](https://arxiv.org/abs/2602.09969)
...
### [23] [UniComp: A Unified Evaluation of Large Language Model Compression via Pruning, Quantization and Distillation](https://arxiv.org/abs/2602.09130)
...
### [24] [A Task-Centric Theory for Iterative Self-Improvement with Easy-to-Hard Curricula](https://arxiv.org/abs/2602.10014)
...
### [25] [What do Geometric Hallucination Detection Metrics Actually Measure?](https://arxiv.org/abs/2602.09158)
...
### [26] [WildCat: Near-Linear Attention in Theory and Practice](https://arxiv.org/abs/2602.10056)
...
### [27] [Boltzmann Reinforcement Learning for Noise resilience in Analog Ising Machines](https://arxiv.org/abs/2602.09162)
...
### [28] [Faster Rates For Federated Variational Inequalities](https://arxiv.org/abs/2602.09164)
...
### [29] [Train Less, Infer Faster: Efficient Model Finetuning and Compression via Structured Sparsity](https://arxiv.org/abs/2602.09169)
...
### [30] [Weighted Wasserstein Barycenter of Gaussian Processes for exotic Bayesian Optimization tasks](https://arxiv.org/abs/2602.09181)
...
### [31] [Gradient Residual Connections](https://arxiv.org/abs/2602.09190)
...
### [32] [ML-DCN: Masked Low-Rank Deep Crossing Network Towards Scalable Ads Click-through Rate Prediction at Pinterest](https://arxiv.org/abs/2602.09194)
...
### [33] [CausalGDP: Causality-Guided Diffusion Policies for Reinforcement Learning](https://arxiv.org/abs/2602.09207)
...
### [34] [A Lightweight Multi-View Approach to Short-Term Load Forecasting](https://arxiv.org/abs/2602.09220)
...
### [35] [Barycentric alignment for instance-level comparison of neural representations](https://arxiv.org/abs/2602.09225)
...
### [36] [Beyond the Unit Hypersphere: Embedding Magnitude in Contrastive Learning](https://arxiv.org/abs/2602.09229)
...
### [37] [Do Neural Networks Lose Plasticity in a Gradually Changing World?](https://arxiv.org/abs/2602.09234)
...
### [38] [RAPID: Risk of Attribute Prediction-Induced Disclosure in Synthetic Microdata](https://arxiv.org/abs/2602.09235)
...
### [39] [Feature salience -- not task-informativeness -- drives machine learning model explanations](https://arxiv.org/abs/2602.09238)
...
### [40] [Generalizing GNNs with Tokenized Mixture of Experts](https://arxiv.org/abs/2602.09258)
...
### [41] [The effect of whitening on explanation performance](https://arxiv.org/abs/2602.09278)
...
### [42] [Measuring Privacy Risks and Tradeoffs in Financial Synthetic Data Generation](https://arxiv.org/abs/2602.09288)
...
### [43] [Positive-Unlabelled Active Learning to Curate a Dataset for Orca Resident Interpretation](https://arxiv.org/abs/2602.09295)
...
### [44] [The Laplacian Mechanism Improves Transformers by Reshaping Token Geometry](https://arxiv.org/abs/2602.09297)
...
### [45] [Risk-sensitive reinforcement learning using expectiles, shortfall risk and optimized certainty equivalent risk](https://arxiv.org/abs/2602.09300)
...
### [46] [Statistical Roughness-Informed Machine Unlearning](https://arxiv.org/abs/2602.09304)
...
### [47] [Reward Modeling for Reinforcement Learning-Based LLM Reasoning: Design, Challenges, and Evaluation](https://arxiv.org/abs/2602.09305)
...
### [48] [Empowering Contrastive Federated Sequential Recommendation with LLMs](https://arxiv.org/abs/2602.09306)
...
### [49] [Effective MoE-based LLM Compression by Exploiting Heterogeneous Inter-Group Experts Routing Frequency and Information Density](https://arxiv.org/abs/2602.09316)
...
### [50] [Priority-Aware Shapley Value](https://arxiv.org/abs/2602.09326)
...
### [51] [In-Hospital Stroke Prediction from PPG-Derived Hemodynamic Features](https://arxiv.org/abs/2602.09328)
...
### [52] [MacrOData: New Benchmarks of Thousands of Datasets for Tabular Outlier Detection](https://arxiv.org/abs/2602.09329)
...
### [53] [Large Language Models for Designing Participatory Budgeting Rules](https://arxiv.org/abs/2602.09349)
...
### [54] [Latent Poincaré Shaping for Agentic Reinforcement Learning](https://arxiv.org/abs/2602.09375)
...
### [55] [Sparse Layer Sharpness-Aware Minimization for Efficient Fine-Tuning](https://arxiv.org/abs/2602.09395)
...
### [56] [Squeezing More from the Stream : Learning Representation Online for Streaming Reinforcement Learning](https://arxiv.org/abs/2602.09396)
...
### [57] [Learning with Multiple Correct Answers -- A Trichotomy of Regret Bounds under Different Feedback Models](https://arxiv.org/abs/2602.09402)
...
### [58] [Diffusion-Guided Pretraining for Brain Graph Foundation Models](https://arxiv.org/abs/2602.09437)
...
### [59] [Scalable and Reliable State-Aware Inference of High-Impact N-k Contingencies](https://arxiv.org/abs/2602.09461)
...
### [60] [Online Learning in MDPs with Partially Adversarial Transitions and Losses](https://arxiv.org/abs/2602.09474)
...
### [63] [Towards Uniformity and Alignment for Multimodal Representation Learning](https://arxiv.org/abs/2602.09507)
...
### [64] [Beyond Student: An Asymmetric Network for Neural Network Inheritance](https://arxiv.org/abs/2602.09509)
...
### [65] [Rashomon Sets and Model Multiplicity in Federated Learning](https://arxiv.org/abs/2602.09520)
...
### [66] [ECG-IMN: Interpretable Mesomorphic Neural Networks for 12-Lead Electrocardiogram Interpretation](https://arxiv.org/abs/2602.09566)
...
### [68] [Rollout-Training Co-Design for Efficient LLM-Based Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2602.09578)
...
### [69] [Mitigating the Likelihood Paradox in Flow-based OOD Detection via Entropy Manipulation](https://arxiv.org/abs/2602.09581)
...
### [70] [Why the Counterintuitive Phenomenon of Likelihood Rarely Appears in Tabular Anomaly Detection with Deep Generative Models?](https://arxiv.org/abs/2602.09593)
...
### [71] [LLM-FS: Zero-Shot Feature Selection for Effective and Interpretable Malware Detection](https://arxiv.org/abs/2602.09634)
...
### [72] [Resilient Class-Incremental Learning: on the Interplay of Drifting, Unlabelled and Imbalanced Data Streams](https://arxiv.org/abs/2602.09681)
...
### [73] [Model soups need only one ingredient](https://arxiv.org/abs/2602.09689)
...
### [74] [Contextual and Seasonal LSTMs for Time Series Anomaly Detection](https://arxiv.org/abs/2602.09690)
...
### [75] [BRAVA-GNN: Betweenness Ranking Approximation Via Degree MAss Inspired Graph Neural Network](https://arxiv.org/abs/2602.09716)
...
### [76] [ExO-PPO: an Extended Off-policy Proximal Policy Optimization Algorithm](https://arxiv.org/abs/2602.09726)
...
### [77] [Towards Poisoning Robustness Certification for Natural Language Generation](https://arxiv.org/abs/2602.09757)
...
### [78] [Grounding LTL Tasks in Sub-Symbolic RL Environments for Zero-Shot Generalization](https://arxiv.org/abs/2602.09761)
...
### [79] [Explainability in Generative Medical Diffusion Models: A Faithfulness-Based Analysis on MRI Synthesis](https://arxiv.org/abs/2602.09781)
...
### [80] [Flexible Entropy Control in RLVR with Gradient-Preserving Perspective](https://arxiv.org/abs/2602.09782)
...
### [81] [Why Linear Interpretability Works: Invariant Subspaces as a Result of Architectural Constraints](https://arxiv.org/abs/2602.09783)
...
### [82] [Circuit Fingerprints: How Answer Tokens Encode Their Geometrical Path](https://arxiv.org/abs/2602.09784)
...
### [83] [When Less is More: The LLM Scaling Paradox in Context Compression](https://arxiv.org/abs/2602.09789)
...
### [84] [A Controlled Study of Double DQN and Dueling DQN Under Cross-Environment Transfer](https://arxiv.org/abs/2602.09810)
...
### [85] [PlugSI: Plug-and-Play Test-Time Graph Adaptation for Spatial Interpolation](https://arxiv.org/abs/2602.09824)
...
### [86] [CoFEH: LLM-driven Feature Engineering Empowered by Collaborative Bayesian Hyperparameter Optimization](https://arxiv.org/abs/2602.09851)
...
### [87] [Differentiable Tripartite Modularity for Clustering Heterogeneous Graphs](https://arxiv.org/abs/2602.09864)
*Benoît Hurpeau*
...
### [88] [Statistical benchmarking of transformer models in low signal-to-noise time-series forecasting](https://arxiv.org/abs/2602.09869)
...
### [89] [Safeguarding Privacy: Privacy-Preserving Detection of Mind Wandering and Disengagement Using Federated Learning in Online Education](https://arxiv.org/abs/2602.09904)
...
### [90] [Drug Release Modeling using Physics-Informed Neural Networks](https://arxiv.org/abs/2602.09963)
...
### [91] [Supervised Metric Regularization Through Alternating Optimization for Multi-Regime Physics-Informed Neural Networks](https://arxiv.org/abs/2602.09980)
...
### [92] [Online Monitoring Framework for Automotive Time Series Data using JEPA Embeddings](https://arxiv.org/abs/2602.09985)
...
### [97] [Position: Message-passing and spectral GNNs are two sides of the same coin](https://arxiv.org/abs/2602.10031)
...
### [101] [Vendi Novelty Scores for Out-of-Distribution Detection](https://arxiv.org/abs/2602.10062)
...
### [102] [Features as Rewards: Scalable Supervision for Open-Ended Tasks via Interpretability](https://arxiv.org/abs/2602.10067)
...
### [103] [Step-resolved data attribution for looped transformers](https://arxiv.org/abs/2602.10097)
...
### [104] [Learning on the Manifold: Unlocking Standard Diffusion Transformers with Representation Encoders](https://arxiv.org/abs/2602.10099)
...
### [105] [Towards Explainable Federated Learning: Understanding the Impact of Differential Privacy](https://arxiv.org/abs/2602.10100)
...
TL;DR: 使用最小距离摘要的鲁棒NPE，基于MMD的距离在测试时自适应摘要，与预训练NPE解耦；通过随机傅里叶特征近似实现高效、无模型的自适应，理论保鲁，实验证明在多任务上显著鲁棒性提升，额外开销很小。


<details>
  <summary>Details</summary>
Motivation: SBI在训练分布下估计的NPE对分布偏移敏感；现有鲁棒SBI多通过训练修改或引入误差模型，牺牲了 amortization 与模块化能力。本工作旨在提供一个能够独立适配测试摘要的轻量鲁棒方法。

Method: 提出最小距离摘要，将MMD作为观测数据与摘要条件预测分布之间的距离；在测试时独立适配摘要，与预训练的NPE解耦；利用随机傅里叶特征近似MMD以实现计算高效、轻量级的自适应；提供理论鲁棒性保证。

Result: 在合成与真实任务上进行实验，证明鲁棒性显著提升，同时附带较低的额外开销。

Conclusion: 最小距离摘要提供一种可直接插件到NPE的鲁棒方法，保留了解耦、amortization与模块化的优势，适用于多种SBI场景。
...
TL;DR: 用Fisher信息隔离本质不确定性：提出FLARE，通过对模型参数的随机子集近似Fisher信息，实现扩散模型中 epistemic 不确定性的可扩展估计，优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 当前扩散模型的本体不确定性（epistemic）难以单独衡量，现有方法往往混淆了 epistemic 与 aleatoric，导致不可靠的置信度/ plausibility 分数。需要一个可扩展、明确聚焦于 epistemic 的估计方案。

Method: 提出基于Fisher信息的框架以分离 epistemic 方差；引入FLARE（Fisher-Laplace Randomized Estimator），通过对模型参数的均匀随机子集近似Fisher信息，从而实现可扩展的本体不确定性估计；强调最后一层Laplace近似对该任务不足。

Result: 在合成时间序列生成任务中，FLARE提高了不确定性估计的质量，给出更准确、可靠的过滤效果，相较于其他方法表现更好。

Conclusion: FLARE提供了一种可扩展且基于理论保证的epistemic不确定性估计方法，适用于扩散模型；理论证明/实证证据还指出仅使用最后一层Laplace近似不足以捕获该任务的本体不确定性。
...
### [109] [Mutual Information Collapse Explains Disentanglement Failure in $β$-VAEs](https://arxiv.org/abs/2602.09277)
...
### [110] [The Critical Horizon: Inspection Design Principles for Multi-Stage Operations and Deep Reasoning](https://arxiv.org/abs/2602.09394)
*Seyed Morteza Emadi*
...
### [111] [Is Memorization Helpful or Harmful? Prior Information Sets the Threshold](https://arxiv.org/abs/2602.09405)
...
### [112] [From Average Sensitivity to Small-Loss Regret Bounds under Random-Order Model](https://arxiv.org/abs/2602.09457)
...
### [113] [The Entropic Signature of Class Speciation in Diffusion Models](https://arxiv.org/abs/2602.09651)
...
### [114] [Continual Learning for non-stationary regression via Memory-Efficient Replay](https://arxiv.org/abs/2602.09720)
...
### [115] [Stabilized Maximum-Likelihood Iterative Quantum Amplitude Estimation for Structural CVaR under Correlated Random Fields](https://arxiv.org/abs/2602.09847)
*Alireza Tabarraei*
...
### [116] [The Catastrophic Failure of The k-Means Algorithm in High Dimensions, and How Hartigan's Algorithm Avoids It](https://arxiv.org/abs/2602.09936)
