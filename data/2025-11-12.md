...
### [1] [Robust Experimental Design via Generalised Bayesian Inference](https://arxiv.org/abs/2511.07671)
*Yasir Zubayr Barlas,Sabina J. Sloman,Samuel Kaski*

Main category: stat.ML

TL;DR: 提出 Generalised Bayesian Optimal Experimental Design (GBOED)，在实验设计中结合通用贝叶斯/吉布斯推理，使用 Gibbs 期望信息增益作为获取函数，提升对模型错配和噪声分布偏差的鲁棒性。


<details>
  <summary>Details</summary>
Motivation: 经典贝叶斯设计依赖于正确的生成模型，若模型不正确，信息增益估计与推断会受严重影响。需要一个在设计和推断层面都更鲁棒的框架。

Method: 将 Generalised Bayesian / Gibbs 推理引入实验设计，替代似然项以损失函数更新，构建扩展的信息理论框架，推导 Gibbs EIG 作为获取新数据的度量，形成 GBOED 框架。

Result: 实证显示 GBOED 对离群点和对观测噪声分布假设不准确的情况具有更强鲁棒性，提升信息增益估计的稳定性。

Conclusion: GBOED 提供一个在设计和推断上都更鲁棒的通用贝叶斯最优实验设计方案，Gibbs EIG 为鲁棒信息获取提供有效的新工具。
...
### [2] [Tractable Instances of Bilinear Maximization: Implementing LinUCB on Ellipsoids](https://arxiv.org/abs/2511.07504)
...
### [3] [Infinite-Dimensional Operator/Block Kaczmarz Algorithms: Regret Bounds and $λ$-Effectiveness](https://arxiv.org/abs/2511.07604)
...
### [4] [Distributionally Robust Online Markov Game with Linear Function Approximation](https://arxiv.org/abs/2511.07831)
...
### [5] [PrAda-GAN: A Private Adaptive Generative Adversarial Network with Bayes Network Structure](https://arxiv.org/abs/2511.07997)
...
### [6] [Semi-Supervised Treatment Effect Estimation with Unlabeled Covariates via Generalized Riesz Regression](https://arxiv.org/abs/2511.08303)
*Masahiro Kato*
...
### [7] [Concentration bounds on response-based vector embeddings of black-box generative models](https://arxiv.org/abs/2511.08307)
...
### [8] [Source-Optimal Training is Transfer-Suboptimal](https://arxiv.org/abs/2511.08401)
*C. Evans Hedges*
...
### [9] [Optimizing Classification of Infrequent Labels by Reducing Variability in Label Distribution](https://arxiv.org/abs/2511.07459)
*Ashutosh Agarwal*
...
### [10] [Towards Personalized Quantum Federated Learning for Anomaly Detection](https://arxiv.org/abs/2511.07471)
...
### [11] [On the Role of Calibration in Benchmarking Algorithmic Fairness for Skin Cancer Detection](https://arxiv.org/abs/2511.07700)
...
### [13] [Global Optimization on Graph-Structured Data via Gaussian Processes with Spectral Representations](https://arxiv.org/abs/2511.07734)
...
### [14] [From Exploration to Exploitation: A Two-Stage Entropy RLVR Approach for Noise-Tolerant MLLM Training](https://arxiv.org/abs/2511.07738)
...
TL;DR: 提出一个两阶段的 token-level entropy 优化方法以提升 RLVR 的鲁棒性，在探索-开发之间动态调控，提升噪声场景下的奖励梯度估计和预测准确性，在三种 Qwen-VL 模型上取得优于现有方法的综合性能。


<details>
  <summary>Details</summary>
Motivation: 高质量标注数据稀缺且易受注释噪声影响，现有无监督 RLVR 容易对错误标签过拟合，削弱奖励排序信号，需增强对噪声的容忍与稳定性。

Method: 提出两阶段的 token-level 熵优化：阶段1 进行熵最大化以促进多样性和探索，作为正则化防止过早收敛到噪声标签并提升分组内部变异，从而更可靠地估计 GRPO 的奖励梯度；阶段2 转向熵最小化以实现输出的自信性与确定性，巩固学习并提升预测准确性。训练在探索-开发之间动态切换。

Result: 在 Qwen2-VL-2B、Qwen2-VL-7B、Qwen2.5-VL-3B 三种骨架上，覆盖多种噪声设置和多任务，分阶段策略统一并超越外部、内部及基于熵的方法的组合，展现出对噪声场景的鲁棒性和优越性。

Conclusion: 两阶段的 token-level 熵优化为 RLVR 在多模态大语言模型中的鲁棒性和性能提升提供有效手段，特别是在带噪声数据的现实场景中。
...
### [15] [Physical Consistency of Aurora's Encoder: A Quantitative Study](https://arxiv.org/abs/2511.07787)
...
### [16] [Analyzing Political Text at Scale with Online Tensor LDA](https://arxiv.org/abs/2511.07809)
...
### [17] [Multi-Objective Bilevel Learning](https://arxiv.org/abs/2511.07824)
*Zhiyao Zhang,Zhuqing Liu,Xin Zhang,Wen-Yen Chen,Jiyan Yang,Jia Liu*

Main category: cs.LG

TL;DR: 提出了一个统一的加权-Chebychev 多超梯度下降框架 WC-MHGD，用于多目标双层学习（MOBL）的确定性和随机性设定，提供有限时间的 Pareto-站态收敛性保证和低查询复杂度，并实现对 Pareto 前线的系统性探索；通过大量实验验证理论结果。


<details>
  <summary>Details</summary>
Motivation: 在深度学习等场景中，存在跨层的多目标并存且相互冲突的问题，传统单目标或单层优化难以同时兼顾多个目标并涉及下层最优解的依赖，需要一个统一、高效的 MOBL 框架来实现偏好引导的 Pareto 均衡与前沿探索。

Method: 提出并实现 WC-MHGD 框架，基于加权的 Chebyshev 距离构造多超梯度更新，适用于确定性与随机性设置，提供有限时间的 Pareto-stationarity 收敛率分析，以及对前沿的系统性探索能力。

Result: 从理论层面给出收敛速度与低 oracle 复杂度的保证；在实验中验证理论结论，显示框架在多目标双层学习中的有效性与可扩展性。

Conclusion: MOBL 研究尚处于起步阶段，本工作提出的统一框架不仅理论上提供收敛和复杂度保证，还在实验中体现出对 Pareto 前沿的探索能力，为未来在更复杂的多目标双层学习问题中提供了可靠工具与方向。
...
### [18] [MURPHY: Multi-Turn GRPO for Self Correcting Code Generation](https://arxiv.org/abs/2511.07833)
...
### [19] [DP-AdamW: Investigating Decoupled Weight Decay and Bias Correction in Private Deep Learning](https://arxiv.org/abs/2511.07843)
...
### [20] [A General Method for Proving Networks Universal Approximation Property](https://arxiv.org/abs/2511.07857)
*Wei Wang*
...
### [21] [Algorithm-Relative Trajectory Valuation in Policy Gradient Control](https://arxiv.org/abs/2511.07878)
...
### [22] [Meta-cognitive Multi-scale Hierarchical Reasoning for Motor Imagery Decoding](https://arxiv.org/abs/2511.07884)
...
### [23] [A Generalized Spectral Framework to Expain Neural Scaling and Compression Dynamics](https://arxiv.org/abs/2511.07892)
*Yizhou Zhang*
...
### [24] [Statistically Assuring Safety of Control Systems using Ensembles of Safety Filters and Conformal Prediction](https://arxiv.org/abs/2511.07899)
...
### [25] [Test-driven Reinforcement Learning](https://arxiv.org/abs/2511.07904)
...
### [26] [CellARC: Measuring Intelligence with Cellular Automata](https://arxiv.org/abs/2511.07908)
*Miroslav Lžičař*
...
### [27] [Rectified Noise: A Generative Model Using Positive-incentive Noise](https://arxiv.org/abs/2511.07911)
...
### [28] [Feedback Descent: Open-Ended Text Optimization via Pairwise Comparison](https://arxiv.org/abs/2511.07919)
...
### [29] [SERL: Self-Examining Reinforcement Learning on Open-Domain](https://arxiv.org/abs/2511.07922)
...
### [30] [IBMA: An Imputation-Based Mixup Augmentation Using Self-Supervised Learning for Time Series Data](https://arxiv.org/abs/2511.07930)
...
### [32] [Balance Equation-based Distributionally Robust Offline Imitation Learning](https://arxiv.org/abs/2511.07942)
...
### [33] [Continual Unlearning for Text-to-Image Diffusion Models: A Regularization Perspective](https://arxiv.org/abs/2511.07970)
...
### [34] [Low-Rank Curvature for Zeroth-Order Optimization in LLM Fine-Tuning](https://arxiv.org/abs/2511.07971)
...
### [35] [Generalizable Insights for Graph Transformers in Theory and Practice](https://arxiv.org/abs/2511.08028)
...
### [36] [From Sequential to Recursive: Enhancing Decision-Focused Learning with Bidirectional Feedback](https://arxiv.org/abs/2511.08035)
...
### [37] [DynaAct: Large Language Model Reasoning with Dynamic Action Spaces](https://arxiv.org/abs/2511.08043)
...
### [38] [Online Linear Regression with Paid Stochastic Features](https://arxiv.org/abs/2511.08073)
...
### [39] [An Integrated Fusion Framework for Ensemble Learning Leveraging Gradient Boosting and Fuzzy Rule-Based Models](https://arxiv.org/abs/2511.08077)
...
### [40] [HipKittens: Fast and Furious AMD Kernels](https://arxiv.org/abs/2511.08083)
...
### [41] [Dynamic Sparsity: Challenging Common Sparsity Assumptions for Learning World Models in Robotic Reinforcement Learning Benchmarks](https://arxiv.org/abs/2511.08086)
...
### [42] [Stuart-Landau Oscillatory Graph Neural Network](https://arxiv.org/abs/2511.08094)
...
### [43] [A robust methodology for long-term sustainability evaluation of Machine Learning models](https://arxiv.org/abs/2511.08120)
...
### [44] [SafeMIL: Learning Offline Safe Imitation Policy from Non-Preferred Trajectories](https://arxiv.org/abs/2511.08136)
...
### [45] [BIPPO: Budget-Aware Independent PPO for Energy-Efficient Federated Learning Services](https://arxiv.org/abs/2511.08142)
...
### [46] [Deep (Predictive) Discounted Counterfactual Regret Minimization](https://arxiv.org/abs/2511.08174)
...
### [47] [Improving Long-Range Interactions in Graph Neural Simulators via Hamiltonian Dynamics](https://arxiv.org/abs/2511.08185)
...
### [48] [The Online Patch Redundancy Eliminator (OPRE): A novel approach to online agnostic continual learning using dataset compression](https://arxiv.org/abs/2511.08226)
...
### [49] [Towards Non-Stationary Time Series Forecasting with Temporal Stabilization and Frequency Differencing](https://arxiv.org/abs/2511.08229)
...
### [50] [PrefPoE: Advantage-Guided Preference Fusion for Learning Where to Explore](https://arxiv.org/abs/2511.08241)
...
### [51] [A Unified Geometric Field Theory Framework for Transformers: From Manifold Embeddings to Kernel Modulation](https://arxiv.org/abs/2511.08243)
...
### [52] [Data-Driven Discovery of Feature Groups in Clinical Time Series](https://arxiv.org/abs/2511.08260)
...
### [53] [Rethinking Explanation Evaluation under the Retraining Scheme](https://arxiv.org/abs/2511.08281)
...
### [54] [Dual-Kernel Graph Community Contrastive Learning](https://arxiv.org/abs/2511.08287)
...
### [55] [Test-time Diverse Reasoning by Riemannian Activation Steering](https://arxiv.org/abs/2511.08305)
...
### [56] [Improving the accuracy and generalizability of molecular property regression models with a substructure-substitution-rule-informed framework](https://arxiv.org/abs/2511.08314)
...
### [57] [Adversarial Bias: Data Poisoning Attacks on Fairness](https://arxiv.org/abs/2511.08331)
...
### [58] [LPPG-RL: Lexicographically Projected Policy Gradient Reinforcement Learning with Subproblem Exploration](https://arxiv.org/abs/2511.08339)
...
### [59] [From Confusion to Clarity: ProtoScore - A Framework for Evaluating Prototype-Based XAI](https://arxiv.org/abs/2511.08361)
...
### [60] [Multi-objective Hyperparameter Optimization in the Age of Deep Learning](https://arxiv.org/abs/2511.08371)
...
### [61] [EMAformer: Enhancing Transformer through Embedding Armor for Time Series Forecasting](https://arxiv.org/abs/2511.08396)
...
### [62] [Aligning by Misaligning: Boundary-aware Curriculum Learning for Multimodal Alignment](https://arxiv.org/abs/2511.08399)
...
### [63] [ARAC: Adaptive Regularized Multi-Agent Soft Actor-Critic in Graph-Structured Adversarial Games](https://arxiv.org/abs/2511.08412)
...
### [64] [NeuCLIP: Efficient Large-Scale CLIP Training with Neural Normalizer Optimization](https://arxiv.org/abs/2511.08417)
...
### [65] [Physics-Informed Neural Operators for Cardiac Electrophysiology](https://arxiv.org/abs/2511.08418)
...
### [66] [HardFlow: Hard-Constrained Sampling for Flow-Matching Models via Trajectory Optimization](https://arxiv.org/abs/2511.08425)
...
### [67] [An update to PYRO-NN: A Python Library for Differentiable CT Operators](https://arxiv.org/abs/2511.08427)
...
### [68] [Coherence Mechanisms for Provable Self-Improvement](https://arxiv.org/abs/2511.08440)
...
### [69] [One Model for All: Universal Pre-training for EEG based Emotion Recognition across Heterogeneous Datasets and Paradigms](https://arxiv.org/abs/2511.08444)
...
### [70] [Binary Split Categorical feature with Mean Absolute Error Criteria in CART](https://arxiv.org/abs/2511.08470)
...
### [71] [Clustering Guided Residual Neural Networks for Multi-Tx Localization in Molecular Communications](https://arxiv.org/abs/2511.08513)
...
### [72] [LeJEPA: Provable and Scalable Self-Supervised Learning Without the Heuristics](https://arxiv.org/abs/2511.08544)
...
### [73] [FMMI: Flow Matching Mutual Information Estimation](https://arxiv.org/abs/2511.08552)
...
### [74] [The Path Not Taken: RLVR Provably Learns Off the Principals](https://arxiv.org/abs/2511.08567)
...
### [75] [Automatic Grid Updates for Kolmogorov-Arnold Networks using Layer Histograms](https://arxiv.org/abs/2511.08570)
