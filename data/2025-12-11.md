...
### [1] [Branching Strategies Based on Subgraph GNNs: A Study on Theoretical Promise versus Practical Reality](https://arxiv.org/abs/2512.09355)
...
### [2] [Optimizing Algorithms for Mobile Health Interventions with Active Querying Optimization](https://arxiv.org/abs/2512.08950)
*Aseel Rawashdeh*
...
### [8] [Beyond the Hype: Comparing Lightweight and Deep Learning Models for Air Quality Forecasting](https://arxiv.org/abs/2512.09076)
...
### [9] [Resolving Conflicts in Lifelong Learning via Aligning Updates in Subspaces](https://arxiv.org/abs/2512.08960)
...
### [10] [Drawback of Enforcing Equivariance and its Compensation via the Lens of Expressive Power](https://arxiv.org/abs/2512.09673)
...
### [11] [SEA: Spectral Edge Attacks on Graph Neural Networks](https://arxiv.org/abs/2512.08964)
*Yongyu Wang*
...
### [12] [Provably Learning from Modern Language Models via Low Logit Rank](https://arxiv.org/abs/2512.09892)
...
### [13] [Financial Instruction Following Evaluation (FIFE)](https://arxiv.org/abs/2512.08965)
*Glenn Matlin,Siddharth,Anirudh JM,Aditya Shukla,Yahya Hassan,Sudheer Chava*

Main category: cs.LG

TL;DR: 提出了 FIFE，一个高难度的金融分析指令跟随基准，含 88 条人类撰写的提示和可验证的链式约束验证系统，用于细粒度奖励信号。对53种模型进行零-shot 评估。结果显示：开源加权模型在测试中超越领先的专有系统，但最佳的开源模型仍明显落后；尚无模型达到完全合规。公开数据集和代码，促进金融领域的强化学习研究。


<details>
  <summary>Details</summary>
Motivation: 在高风险金融场景中，评估大语言模型对复杂、相互依赖指令的执行能力极为重要。现有基准可能无法充分覆盖链式推理和可验证约束的需求，因此需要一个更具挑战性的、带有可验证约束的基准来推动模型改进。

Method: 构建 88 条人工撰写的金融分析提示，设计带有可追溯、可链式验证的约束的验证系统，以提供细粒度的奖励信号。对 53 种模型在零-shot 场景下进行评测，并以严格/宽松两种评分策略比较模型表现。

Result: 在严格评分下，开源加权模型最高为 76.1，宽松评分为 79.5；领先的专有系统为 65.9/70.5；最佳开源模型为 45.5/48.9；均未达到完全合规。

Conclusion: FIFE 揭示了金融领域指令跟随任务中，开源模型虽然领先，但仍与理想合规存在显著差距。数据集与代码已开源，旨在促进基于强化学习的金融领域研究；未来需要进一步提升模型对复杂、可验证约束的遵循能力。
...
### [14] [CluCERT: Certifying LLM Robustness via Clustering-Guided Denoising Smoothing](https://arxiv.org/abs/2512.08967)
...
### [15] [StructuredDNA: A Bio-Physical Framework for Energy-Aware Transformer Routing](https://arxiv.org/abs/2512.08968)
*Mustapha Hamdi*
...
### [16] [Learning Robust Representations for Malicious Content Detection via Contrastive Sampling and Uncertainty Estimation](https://arxiv.org/abs/2512.08969)
...
### [17] [Peek-a-Boo Reasoning: Contrastive Region Masking in MLLMs](https://arxiv.org/abs/2512.08976)
...
### [18] [Graph Deep Learning for Intracranial Aneurysm Blood Flow Simulation and Risk Assessment](https://arxiv.org/abs/2512.09013)
...
### [19] [Improving Multi-Class Calibration through Normalization-Aware Isotonic Techniques](https://arxiv.org/abs/2512.09054)
...
### [20] [A Diffusion-Based Framework for High-Resolution Precipitation Forecasting over CONUS](https://arxiv.org/abs/2512.09059)
...
### [21] [Contrast transfer functions help quantify neural network out-of-distribution generalization in HRTEM](https://arxiv.org/abs/2512.09067)
...
### [22] [Modular Deep-Learning-Based Early Warning System for Deadly Heatwave Prediction](https://arxiv.org/abs/2512.09074)
...
### [23] [GS-KAN: Parameter-Efficient Kolmogorov-Arnold Networks via Sprecher-Type Shared Basis Functions](https://arxiv.org/abs/2512.09084)
*Oscar Eliasson*
...
### [24] [Natural Geometry of Robust Data Attribution: From Convex Models to Deep Networks](https://arxiv.org/abs/2512.09103)
...
### [25] [Learning Unmasking Policies for Diffusion Language Models](https://arxiv.org/abs/2512.09106)
...
### [26] [Spectral Embedding via Chebyshev Bases for Robust DeepONet Approximation](https://arxiv.org/abs/2512.09165)
...
### [27] [Understanding the Failure Modes of Transformers through the Lens of Graph Neural Networks](https://arxiv.org/abs/2512.09182)
*Hunjae Lee*
...
### [31] [Goal inference with Rao-Blackwellized Particle Filters](https://arxiv.org/abs/2512.09269)
...
TL;DR: GPSSL 将高斯过程引入自监督学习，对表示学习引入不确定性并可传播到下游任务，等价于核PCA与 VICReg 的结合，能提供不确定性估计和更好错误控制。


<details>
  <summary>Details</summary>
Motivation: 现有 SSL 需明确的正样本对，难以生成，且缺乏不确定性量化，泛化到 out-of-sample 预测能力不足。

Method: 在表示学习上对表示引入高斯过程先验，通过通用贝叶斯后验最小化一个损失，以鼓励信息丰富的表示。GP 的协方差能把相似的表示拉近，替代显式的正样本。与核PCA和VICReg相关，且可产生后验不确定性。

Result: 在分类与回归任务上，GPSSL 在准确率、不确定性量化和错误控制方面优于传统方法。

Conclusion: GPSSL 提供一种将 GP 与 SSL 融合的新框架，能够在表示学习中输出不确定性并提升下游任务表现。
...
### [35] [A Granular Framework for Construction Material Price Forecasting: Econometric and Machine-Learning Approaches](https://arxiv.org/abs/2512.09360)
...
### [36] [KGOT: Unified Knowledge Graph and Optimal Transport Pseudo-Labeling for Molecule-Protein Interaction Prediction](https://arxiv.org/abs/2512.09365)
...
### [37] [CFLight: Enhancing Safety with Traffic Signal Control through Counterfactual Learning](https://arxiv.org/abs/2512.09368)
...
### [38] [Are Hypervectors Enough? Single-Call LLM Reasoning over Knowledge Graphs](https://arxiv.org/abs/2512.09369)
...
### [39] [Rates and architectures for learning geometrically non-trivial operators](https://arxiv.org/abs/2512.09376)
...
### [40] [Federated Distillation Assisted Vehicle Edge Caching Scheme Based on Lightweight DDPM](https://arxiv.org/abs/2512.09378)
...
### [41] [Towards Resilient Transportation: A Conditional Transformer for Accident-Informed Traffic Forecasting](https://arxiv.org/abs/2512.09398)
...
### [42] [Black-Box Behavioral Distillation Breaks Safety Alignment in Medical LLMs](https://arxiv.org/abs/2512.09403)
...
### [43] [Cauchy-Schwarz Fairness Regularizer](https://arxiv.org/abs/2512.09467)
...
### [44] [Representation Invariance and Allocation: When Subgroup Balance Matters](https://arxiv.org/abs/2512.09496)
...
### [45] [Contextual Dynamic Pricing with Heterogeneous Buyers](https://arxiv.org/abs/2512.09513)
...
### [46] [QuanvNeXt: An end-to-end quanvolutional neural network for EEG-based detection of major depressive disorder](https://arxiv.org/abs/2512.09517)
...
### [47] [Stanford Sleep Bench: Evaluating Polysomnography Pre-training Methods for Sleep Foundation Models](https://arxiv.org/abs/2512.09591)
...
### [48] [Semantic-Aware Cooperative Communication and Computation Framework in Vehicular Networks](https://arxiv.org/abs/2512.09621)
...
### [49] [Membership and Dataset Inference Attacks on Large Audio Generative Models](https://arxiv.org/abs/2512.09654)
...
### [50] [A data-driven approach to linking design features with manufacturing process data for sustainable product development](https://arxiv.org/abs/2512.09690)
...
### [51] [Training One Model to Master Cross-Level Agentic Actions via Reinforcement Learning](https://arxiv.org/abs/2512.09706)
...
### [52] [Mixture of Lookup Key-Value Experts](https://arxiv.org/abs/2512.09723)
*Zongcheng Wang*
...
### [53] [Circuits, Features, and Heuristics in Molecular Transformers](https://arxiv.org/abs/2512.09757)
...
### [54] [Physics-Aware Heterogeneous GNN Architecture for Real-Time BESS Optimization in Unbalanced Distribution Systems](https://arxiv.org/abs/2512.09780)
...
### [55] [TinyDéjàVu: Smaller Memory Footprint & Faster Inference on Sensor Data Streams with Always-On Microcontrollers](https://arxiv.org/abs/2512.09786)
*Zhaolan Huang,Emmanuel Baccelli*

Main category: cs.LG

TL;DR: TinyDéjàVu 在微控制器上通过优化数据流与重用计算，显著降低时序传感数据上 Tiny ML 模型的 RAM 需求。


<details>
  <summary>Details</summary>
Motivation: 在受限 RAM/能耗的 MCU 场景下，持续运行传感器数据的 Tiny ML 变得困难，需降低 RAM 使用和冗余计算。

Method: 提出 TinyDéjàVu 框架和算法，优化跨层数据流、减少 sliding window 输入的重复计算，支持多种 tiny ML 模型，开源实现并在硬件上进行可重复基准测试。

Result: 实现超过 60% 的 RAM 节省，针对重叠滑动窗口输入可去除高达 90% 的冗余计算，并提供可复现的硬件基准。

Conclusion: 为传感器时间序列上的 Tiny ML 提供高效内存与计算优化方案，适用于 128kB 级 RAM 的 MCU，并具备开源和可重复性，推动边缘 AI 的能耗友好实现。
...
### [56] [Knowledge Diversion for Efficient Morphology Control and Policy Transfer](https://arxiv.org/abs/2512.09796)
...
### [57] [Ariel-ML: Computing Parallelization with Embedded Rust for Neural Networks on Heterogeneous Multi-core Microcontrollers](https://arxiv.org/abs/2512.09800)
...
### [58] [Incorporating Fairness in Neighborhood Graphs for Fair Spectral Clustering](https://arxiv.org/abs/2512.09810)
...
### [59] [Predicting the Containment Time of California Wildfires Using Machine Learning](https://arxiv.org/abs/2512.09835)
*Shashank Bhardwaj*
...
### [60] [Conformal Bandits: Bringing statistical validity and reward efficiency to the small-gap regime](https://arxiv.org/abs/2512.09850)
...
### [61] [HPM-KD: Hierarchical Progressive Multi-Teacher Framework for Knowledge Distillation and Efficient Model Compression](https://arxiv.org/abs/2512.09886)
...
### [62] [Analysis of Dirichlet Energies as Over-smoothing Measures](https://arxiv.org/abs/2512.09890)
...
### [63] [STACHE: Local Black-Box Explanations for Reinforcement Learning Policies](https://arxiv.org/abs/2512.09909)
...
### [64] [FALCON: Few-step Accurate Likelihoods for Continuous Flows](https://arxiv.org/abs/2512.09914)
...
### [65] [Closing the Train-Test Gap in World Models for Gradient-Based Planning](https://arxiv.org/abs/2512.09929)
...
### [66] [Online Inference of Constrained Optimization: Primal-Dual Optimality and Sequential Quadratic Programming](https://arxiv.org/abs/2512.08948)
*Yihang Gao,Michael K. Ng,Michael W. Mahoney,Sen Na*

Main category: stat.ML

TL;DR: 提出一种基于在线约束随机优化的SSQP方法，结合动量去偏的梯度更新，首次在不投影到约束集的前提下实现 primal–dual 极小极大下的渐近最优性并提供插件协方差估计，用于在线推断。


<details>
  <summary>Details</summary>
Motivation: 在带等式与不等式约束的随机优化中，尽管梯度估计无偏，但步长方向存在偏差，直接在约束下做推断困难，且往往需要不可行的投影。需要一个能够在线进行统计推断且具备理论最优性的算法。

Method: 提出在线序列二次规划（SSQP）方法：通过对目标函数进行二次近似、对约束进行线性化来得到步长；引入动量风格的梯度滑动平均以消除步长中的偏差；在全局几乎必然收敛的同时，证明局部渐近正态性并给出最优的原-对偶协方差矩阵；给出可直接使用的协方差插件估计器；无需对非线性约束进行投影。

Result: 理论层面证明：global almost-sure convergence 和 局部渐近正态性，具备原-对偶极小极大下的渐近极限协方差的最优性；提供插件协方差估计器；实验上在非线性、约束广义线性模型及组合投资等问题中表现优越，且实现了在线推断的实用性。

Conclusion: 该方法是首个在严格在线条件下实现原-对偶渐近极限最优性且不依赖难以计算的投影操作的在线方法，能够在现实数据场景中提供有效的推断与性能。
...
### [67] [WTNN: Weibull-Tailored Neural Networks for survival analysis](https://arxiv.org/abs/2512.09163)
...
### [68] [Robust and Sparse Estimation of Unbounded Density Ratio under Heavy Contamination](https://arxiv.org/abs/2512.09266)
*Ryosuke Nagumo,Hironori Fujisawa*

Main category: stat.ML

TL;DR: 提出对鲁棒密度比估计的非渐近分析，证明加权DRE在重污染下仍具稀疏一致性，并给出未界定密度比和强鲁棒性的非渐近理论。


<details>
  <summary>Details</summary>
Motivation: 在污染数据环境中进行密度比估计与鲁棒估计的理论保障不足，需非渐近框架来评估方法的鲁棒性与稀疏性。

Method: 引入加权密度比估计及其有界假设，给出非渐近性质；提出双重强鲁棒性框架，在污染比小或离群点的加权值小等条件下进行分析。

Result: 证明Weighted DRE在重污染下具稀疏一致性；在密度比可被有界约束时，给出未界定比的非渐近性质；首次给出强鲁棒性在重污染下的非渐近分析。

Conclusion: 本文首次建立了在重污染条件下的非渐近强鲁棒性分析，并提供了密度比估计和鲁棒估计的实证和理论框架，为鲁棒DRE与相关估计的非渐近理论提供新方向。
...
### [69] [Impact of Positional Encoding: Clean and Adversarial Rademacher Complexity for Transformers under In-Context Regression](https://arxiv.org/abs/2512.09275)
*Weiyi He,Yue Xing*
...
### [70] [Estimation of Stochastic Optimal Transport Maps](https://arxiv.org/abs/2512.09499)
...
### [71] [Transformers for Tabular Data: A Training Perspective of Self-Attention via Optimal Transport](https://arxiv.org/abs/2512.09530)
...
### [72] [Don't Throw Away Your Beams: Improving Consistency-based Uncertainties in LLMs via Beam Search](https://arxiv.org/abs/2512.09538)
...
### [73] [Supervised learning pays attention](https://arxiv.org/abs/2512.09912)
