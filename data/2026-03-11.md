...
### [1] [Memorization capacity of deep ReLU neural networks characterized by width and depth](https://arxiv.org/abs/2603.09589)
...
### [2] [OptEMA: Adaptive Exponential Moving Average for Stochastic Optimization with Zero-Noise Optimality](https://arxiv.org/abs/2603.09923)
*Ganzhao Yuan*

Main category: cs.LG

TL;DR: 提出 OptEMA 及其两种变体（OptEMA-M、OptEMA-V），实现对梯度的一种自适应、闭环 EMA 的优化器，在不依赖 Lipschitz 常数的前提下，获得噪声自适应收敛并在零噪声下达到近似最优的 Õ(T^{-1/2}) 收敛速率。


<details>
  <summary>Details</summary>
Motivation: 传统 Adam-类分析在零噪声下往往 suboptimal、需要有界性假设、使用固定或开环步长，或依赖 Lipschitz 常数等限制；需要一个无需 Lipschitz 依赖、且自适应的理论与方法来提升收敛性和鲁棒性。

Method: 提出 OptEMA，并分析两种变体：OptEMA-M 对一阶矩的 EMA 系数自适应递减、二阶系数保持固定；OptEMA-V 将二阶系数自适应、EMA 一阶）。这两者均为闭环、轨迹敏感的有效步长，不需要参数化时的 Lipschitz 常数。

Result: 在标准 SGD 假设下（平滑性、目标下界、无偏梯度且方差有界），给出收敛性保证，平均梯度范数的收敛速率为 tilde O(T^{-1/2} + σ^{1/2} T^{-1/4})，其中 σ 为梯度噪声水平；σ=0 时收敛到近似最优的确定性速率 tilde O(T^{-1/2})，无需手动超参数调优。

Conclusion: OptEMA 提供了一种无需 Lipschitz 常数的自适应 EMA 优化框架，在有无噪声条件下均具备稳健的收敛性，强化了对 Adam-类优化器的理论基础与实际可用性。
...
### [15] [Better Bounds for the Distributed Experts Problem](https://arxiv.org/abs/2603.09168)
...
### [16] [The $qs$ Inequality: Quantifying the Double Penalty of Mixture-of-Experts at Inference](https://arxiv.org/abs/2603.08960)
...
### [17] [Transductive Generalization via Optimal Transport and Its Application to Graph Node Classification](https://arxiv.org/abs/2603.09257)
...
### [18] [Semantic Level of Detail: Multi-Scale Knowledge Representation via Heat Kernel Diffusion on Hyperbolic Manifolds](https://arxiv.org/abs/2603.08965)
*Edward Izgorodin*
...
### [19] [A Gaussian Comparison Theorem for Training Dynamics in Machine Learning](https://arxiv.org/abs/2603.09310)
*Ashkan Panahi*
...
### [20] [MAcPNN: Mutual Assisted Learning on Data Streams with Temporal Dependence](https://arxiv.org/abs/2603.08972)
...
### [21] [Variational Routing: A Scalable Bayesian Framework for Calibrated Mixture-of-Experts Transformers](https://arxiv.org/abs/2603.09453)
...
### [22] [MAPLE: Elevating Medical Reasoning from Statistical Consensus to Process-Led Alignment](https://arxiv.org/abs/2603.08987)
...
### [23] [MM-algorithms for traditional and convex NMF with Tweedie and Negative Binomial cost functions and empirical evaluation](https://arxiv.org/abs/2603.09601)
...
### [25] [Upper Generalization Bounds for Neural Oscillators](https://arxiv.org/abs/2603.09742)
...
### [26] [An accurate flatness measure to estimate the generalization performance of CNN models](https://arxiv.org/abs/2603.09016)
...
### [27] [A Unified Hierarchical Multi-Task Multi-Fidelity Framework for Data-Efficient Surrogate Modeling in Manufacturing](https://arxiv.org/abs/2603.09842)
...
### [28] [When to Retrain after Drift: A Data-Only Test of Post-Drift Data Size Sufficiency](https://arxiv.org/abs/2603.09024)
...
### [29] [Two Teachers Better Than One: Hardware-Physics Co-Guided Distributed Scientific Machine Learning](https://arxiv.org/abs/2603.09032)
...
### [30] [SCALAR: Learning and Composing Skills through LLM Guided Symbolic Planning and Deep RL Grounding](https://arxiv.org/abs/2603.09036)
...
### [31] [Sim2Act: Robust Simulation-to-Decision Learning via Adversarial Calibration and Group-Relative Perturbation](https://arxiv.org/abs/2603.09053)
...
### [32] [Dynamic Multi-period Experts for Online Time Series Forecasting](https://arxiv.org/abs/2603.09062)
...
### [33] [Learning Adaptive LLM Decoding](https://arxiv.org/abs/2603.09065)
...
### [34] [Exclusive Self Attention](https://arxiv.org/abs/2603.09078)
*Shuangfei Zhai*
...
### [35] [PPO-Based Hybrid Optimization for RIS-Assisted Semantic Vehicular Edge Computing](https://arxiv.org/abs/2603.09082)
...
### [36] [Not All News Is Equal: Topic- and Event-Conditional Sentiment from Finetuned LLMs for Aluminum Price Forecasting](https://arxiv.org/abs/2603.09085)
...
### [37] [Overcoming Valid Action Suppression in Unmasked Policy Gradient Algorithms](https://arxiv.org/abs/2603.09090)
...
### [38] [Probabilistic Hysteresis Factor Prediction for Electric Vehicle Batteries with Graphite Anodes Containing Silicon](https://arxiv.org/abs/2603.09103)
...
### [39] [Decoupling Reasoning and Confidence: Resurrecting Calibration in Reinforcement Learning from Verifiable Rewards](https://arxiv.org/abs/2603.09117)
...
### [40] [Causally Sufficient and Necessary Feature Expansion for Class-Incremental Learning](https://arxiv.org/abs/2603.09145)
...
### [41] [Wrong Code, Right Structure: Learning Netlist Representations from Imperfect LLM-Generated RTL](https://arxiv.org/abs/2603.09161)
...
### [42] [GIAT: A Geologically-Informed Attention Transformer for Lithology Identification](https://arxiv.org/abs/2603.09165)
...
### [43] [Latent-DARM: Bridging Discrete Diffusion And Autoregressive Models For Reasoning](https://arxiv.org/abs/2603.09184)
...
### [44] [$P^2$GNN: Two Prototype Sets to boost GNN Performance](https://arxiv.org/abs/2603.09195)
...
### [45] [The Radio-Frequency Transformer for Signal Separation](https://arxiv.org/abs/2603.09201)
...
### [46] [Strategically Robust Multi-Agent Reinforcement Learning with Linear Function Approximation](https://arxiv.org/abs/2603.09208)
...
### [47] [Beyond Test-Time Training: Learning to Reason via Hardware-Efficient Optimal Control](https://arxiv.org/abs/2603.09221)
...
### [48] [Efficient Reasoning at Fixed Test-Time Cost via Length-Aware Attention Priors and Gain-Aware Training](https://arxiv.org/abs/2603.09253)
*Rian Atri*
...
### [49] [DendroNN: Dendrocentric Neural Networks for Energy-Efficient Classification of Event-Based Data](https://arxiv.org/abs/2603.09274)
...
### [50] [Proxy-Guided Measurement Calibration](https://arxiv.org/abs/2603.09288)
...
### [51] [Reward-Zero: Language Embedding Driven Implicit Reward Mechanisms for Reinforcement Learning](https://arxiv.org/abs/2603.09331)
...
### [52] [TA-GGAD: Testing-time Adaptive Graph Model for Generalist Graph Anomaly Detection](https://arxiv.org/abs/2603.09349)
...
### [53] [Interactive 3D visualization of surface roughness predictions in additive manufacturing: A data-driven framework](https://arxiv.org/abs/2603.09353)
...
### [54] [Democratising Clinical AI through Dataset Condensation for Classical Clinical Models](https://arxiv.org/abs/2603.09356)
...
### [55] [From Representation to Clusters: A Contrastive Learning Approach for Attributed Hypergraph Clustering](https://arxiv.org/abs/2603.09370)
...
### [56] [SPAARS: Safer RL Policy Alignment through Abstract Exploration and Refined Exploitation of Action Space](https://arxiv.org/abs/2603.09378)
...
### [57] [Reconstructing Movement from Sparse Samples: Enhanced Spatio-Temporal Matching Strategies for Low-Frequency Data](https://arxiv.org/abs/2603.09412)
...
### [58] [Impact of Markov Decision Process Design on Sim-to-Real Reinforcement Learning](https://arxiv.org/abs/2603.09427)
...
### [59] [From Weighting to Modeling: A Nonparametric Estimator for Off-Policy Evaluation](https://arxiv.org/abs/2603.09436)
*Rong J. B. Zhu*
...
### [60] [Temporal-Conditioned Normalizing Flows for Multivariate Time Series Anomaly Detection](https://arxiv.org/abs/2603.09490)
...
### [61] [Efficiently Aligning Draft Models via Parameter- and Data-Efficient Adaptation](https://arxiv.org/abs/2603.09527)
...
### [62] [Learning Bayesian and Markov Networks with an Unreliable Oracle](https://arxiv.org/abs/2603.09563)
...
### [63] [An Optimal Control Approach To Transformer Training](https://arxiv.org/abs/2603.09571)
...
### [64] [Routing without Forgetting](https://arxiv.org/abs/2603.09576)
...
### [65] [Towards Understanding Adam Convergence on Highly Degenerate Polynomials](https://arxiv.org/abs/2603.09581)
...
### [66] [Nonparametric Variational Differential Privacy via Embedding Parameter Clipping](https://arxiv.org/abs/2603.09583)
...
### [67] [Learning the Hierarchical Organization in Brain Network for Brain Disorder Diagnosis](https://arxiv.org/abs/2603.09606)
...
### [68] [Well Log-Guided Synthesis of Subsurface Images from Sparse Petrography Data Using cGANs](https://arxiv.org/abs/2603.09651)
...
### [69] [FreqCycle: A Multi-Scale Time-Frequency Analysis Method for Time Series Forecasting](https://arxiv.org/abs/2603.09661)
...
### [70] [No evaluation without fair representation : Impact of label and selection bias on the evaluation, performance and mitigation of classification models](https://arxiv.org/abs/2603.09662)
...
### [71] [GNNs for Time Series Anomaly Detection: An Open-Source Framework and a Critical Evaluation](https://arxiv.org/abs/2603.09675)
...
### [72] [On Catastrophic Forgetting in Low-Rank Decomposition-Based Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2603.09684)
...
### [73] [ActiveUltraFeedback: Efficient Preference Data Generation using Active Learning](https://arxiv.org/abs/2603.09692)
...
### [74] [Physics-informed neural operator for predictive parametric phase-field modelling](https://arxiv.org/abs/2603.09693)
...
### [82] [A Graph-Based Approach to Spectrum Demand Prediction Using Hierarchical Attention Networks](https://arxiv.org/abs/2603.09859)
...
### [83] [GAST: Gradient-aligned Sparse Tuning of Large Language Models with Data-layer Selection](https://arxiv.org/abs/2603.09865)
...
### [84] [CarbonBench: A Global Benchmark for Upscaling of Carbon Fluxes Using Zero-Shot Learning](https://arxiv.org/abs/2603.09868)
...
### [85] [MSSR: Memory-Aware Adaptive Replay for Continual LLM Fine-Tuning](https://arxiv.org/abs/2603.09892)
...
### [86] [Generative Drifting is Secretly Score Matching: a Spectral and Variational Perspective](https://arxiv.org/abs/2603.09936)
...
### [87] [SignalMC-MED: A Multimodal Benchmark for Evaluating Biosignal Foundation Models on Single-Lead ECG and PPG](https://arxiv.org/abs/2603.09940)
...
### [88] [When Learning Rates Go Wrong: Early Structural Signals in PPO Actor-Critic](https://arxiv.org/abs/2603.09950)
...
### [90] [From Data Statistics to Feature Geometry: How Correlations Shape Superposition](https://arxiv.org/abs/2603.09972)
...
### [91] [Task Aware Modulation Using Representation Learning for Upsaling of Terrestrial Carbon Fluxes](https://arxiv.org/abs/2603.09974)
...
### [92] [A Generative Sampler for distributions with possible discrete parameter based on Reversibility](https://arxiv.org/abs/2603.09251)
...
### [93] [On the Formal Limits of Alignment Verification](https://arxiv.org/abs/2603.08761)
*Ayushi Agarwal*
...
### [94] [Micro-Diffusion Compression -- Binary Tree Tweedie Denoising for Online Probability Estimation](https://arxiv.org/abs/2603.08771)
*Roberto Tacconelli*
...
### [95] [Towards Reliable Simulation-based Inference](https://arxiv.org/abs/2603.08947)
*Arnaud Delaunoy*
...
### [96] [Statistical Inference via Generative Models: Flow Matching and Causal Inference](https://arxiv.org/abs/2603.09009)
*Shinto Eguchi*
...
### [97] [Verifying Good Regulator Conditions for Hypergraph Observers: Natural Gradient Learning from Causal Invariance via Established Theorems](https://arxiv.org/abs/2603.09067)
*Max Zhuravlev*
...
### [98] [On Regret Bounds of Thompson Sampling for Bayesian Optimization](https://arxiv.org/abs/2603.09276)
...
### [99] [What Do We Care About in Bandits with Noncompliance? BRACE: Bandits with Recommendations, Abstention, and Certified Effects](https://arxiv.org/abs/2603.09532)
*Nicolás Della Penna*
...
### [100] [a-TMFG: Scalable Triangulated Maximally Filtered Graphs via Approximate Nearest Neighbors](https://arxiv.org/abs/2603.09564)
*Lionel Yelibi*
