...
### [4] [Empirical Likelihood-Based Fairness Auditing: Distribution-Free Certification and Flagging](https://arxiv.org/abs/2601.20269)
...
### [5] [Physics-informed Blind Reconstruction of Dense Fields from Sparse Measurements using Neural Networks with a Differentiable Simulator](https://arxiv.org/abs/2601.20496)
...
### [6] [Incorporating data drift to perform survival analysis on credit risk](https://arxiv.org/abs/2601.20533)
...
### [7] [Sparse clustering via the Deterministic Information Bottleneck algorithm](https://arxiv.org/abs/2601.20628)
...
### [8] [Demystifying Prediction Powered Inference](https://arxiv.org/abs/2601.20819)
...
### [9] [VSCOUT: A Hybrid Variational Autoencoder Approach to Outlier Detection in High-Dimensional Retrospective Monitoring](https://arxiv.org/abs/2601.20830)
*Waldyn G. Martinez*
...
### [11] [ProFlow: Zero-Shot Physics-Consistent Sampling via Proximal Flow Guidance](https://arxiv.org/abs/2601.20227)
*Zichao Yu,Ming Li,Wenyi Zhang,Difan Zou,Weiguo Gao*

Main category: cs.LG

TL;DR: ProFlow: 零次训练的物理一致性采样方法。通过两步近端引导，在固定生成先验下，从稀疏观测中推断满足PDE的解，并在解的生成轨迹上保持先验分布的一致性，实现比最先进基线更好的物理与观测一致性与统计结果。


<details>
  <summary>Details</summary>
Motivation: 在逆问题中，如何在严格满足物理PDE约束的同时，利用已有的强大生成先验进行采样；现有方法要么难以强制硬约束，要么需要昂贵的再训练，破坏先验分布。需要一种零-shot、固定先验即可实现物理一致的采样机制。

Method: 提出 ProFlow：一个两步的近端引导框架。步骤I：终端优化，将预测投影到物理和观测一致性的交集，通过近端最小化实现。步骤II：插值，将 refined 状态映射回生成轨迹，以保持学得的流分布路径的一致性。该过程可被解释为局部最大后验（MAP）更新，并且在不重新训练的前提下使用固定的生成先验进行采样。

Result: 在泊松、亨姆霍兹、达西方方程和粘性 Burgers 方程的广泛基准上，ProFlow 展示了更高的物理与观测一致性，以及更准确的分布统计性，相比最先进的扩散和流基基线。

Conclusion: ProFlow 提供了一种基于近端引导的、零-shot、可在固定生成先验下实现物理一致采样的方法，能够在稀疏观测下保持先验分布结构，同时显著提升物理与观测的符合度与统计推断的准确性。
...
### [12] [DecHW: Heterogeneous Decentralized Federated Learning Exploiting Second-Order Information](https://arxiv.org/abs/2601.19938)
*Adnan Ahmad,Chiara Boldrini,Lorenzo Valerio,Andrea Passarella,Marco Conti*

Main category: cs.LG

TL;DR: 提出一种基于二阶信息的共识权重聚合方法，用以处理去中心化联邦学习中的数据与模型异质性，通过对邻居更新进行加权缩放实现鲁棒聚合，并在视觉任务中展示较低通信成本的良好泛化能力。


<details>
  <summary>Details</summary>
Motivation: 在去中心化联邦学习中，设备间的数据分布和交互程度差异导致本地模型参数存在异质性，进而降低收敛速度并影响泛化。需要一种能在参数层面体现证据置信度的鲁棒聚合策略来缓解这类异质性。

Method: 提出一种基于本地数据集的二阶信息近似来生成共识权重的方法，然后用这些权重对邻居本地更新进行缩放，再将缩放后的更新聚合成全局邻域表示。该过程旨在对参数级别的变化进行更精细的权重分配，从而提升收敛性与鲁棒性。

Result: 在计算机视觉任务的广泛实验中，该方法表现出较强的本地模型泛化能力并显著降低通信成本，体现了对异质性场景的鲁棒性与效率提升。

Conclusion: 所提出的二阶信息驱动的鲁棒聚合框架有效缓解了数据与模型异质性对去中心化联邦学习的影响，具备良好的收敛性、鲁棒性和通信效率，适用于视觉任务等多种应用场景。
...
### [13] [TINNs: Time-Induced Neural Networks for Solving Time-Dependent PDEs](https://arxiv.org/abs/2601.20361)
...
### [15] [Continuous-Flow Data-Rate-Aware CNN Inference on FPGA](https://arxiv.org/abs/2601.19940)
*Tobias Habermann,Michael Mecik,Zhenyu Wang,César David Vera,Martin Kumm,Mario Garrido*

Main category: cs.LG

TL;DR: 提出一种面向CNN的连续流数据速率感知架构，通过在FPGA上交错低数据速率信号并共享硬件单元，以实现接近100%硬件利用率，从而在单FPGA上高吞吐实现复杂CNN（如MobileNet）


<details>
  <summary>Details</summary>
Motivation: 数据流CNN加速器中，池化层和步幅大于1的卷积会显著降低输出数据量，导致完全并行实现时硬件单元利用率下降，制约吞吐与资源效率

Method: 分析CNN数据流，设计数据速率感知的连续流架构；通过信号交错、硬件单元共享以及恰当的并行化策略，保持高数据吞吐，降低算力资源需求

Result: 实验/实现表明可以显著节省算术逻辑资源，并实现MobileNet等复杂CNN在单FPGA上的高吞吐率

Conclusion: 数据速率感知的连续流CNN设计可大幅提升硬件利用率，降低资源开销，为在资源有限平台上实现高性能CNN提供有效路径
...
### [16] [Latent Object Permanence: Topological Phase Transitions, Free-Energy Principles, and Renormalization Group Flows in Deep Transformer Manifolds](https://arxiv.org/abs/2601.19942)
...
### [17] [Emergent Specialization in Learner Populations: Competition as the Source of Diversity](https://arxiv.org/abs/2601.19943)
*Yuhao Li*
...
### [18] [Classifier Calibration at Scale: An Empirical Study of Model-Agnostic Post-Hoc Methods](https://arxiv.org/abs/2601.19944)
...
### [20] [NCSAM Noise-Compensated Sharpness-Aware Minimization for Noisy Label Learning](https://arxiv.org/abs/2601.19947)
...
### [21] [Regime-Adaptive Bayesian Optimization via Dirichlet Process Mixtures of Gaussian Processes](https://arxiv.org/abs/2601.20043)
...
### [22] [Probabilistic Sensing: Intelligence in Data Sampling](https://arxiv.org/abs/2601.19953)
...
### [23] [Order-Optimal Sample Complexity of Rectified Flows](https://arxiv.org/abs/2601.20250)
...
### [25] [Robust Distributed Learning under Resource Constraints: Decentralized Quantile Estimation via (Asynchronous) ADMM](https://arxiv.org/abs/2601.20571)
...
### [26] [Cross-Session Decoding of Neural Spiking Data via Task-Conditioned Latent Alignment](https://arxiv.org/abs/2601.19963)
...
### [27] [SA-PEF: Step-Ahead Partial Error Feedback for Efficient Federated Learning](https://arxiv.org/abs/2601.20738)
...
### [28] [Modeling Cascaded Delay Feedback for Online Net Conversion Rate Prediction: Benchmark, Insights and Solutions](https://arxiv.org/abs/2601.19965)
...
### [29] [Perturbation-Induced Linearization: Constructing Unlearnable Data with Solely Linear Classifiers](https://arxiv.org/abs/2601.19967)
...
### [30] [Decomposing multimodal embedding spaces with group-sparse autoencoders](https://arxiv.org/abs/2601.20028)
...
### [31] [Structural Compositional Function Networks: Interpretable Functional Compositions for Tabular Discovery](https://arxiv.org/abs/2601.20037)
*Fang Li*
...
### [32] [CiMRAG: Cim-Aware Domain-Adaptive and Noise-Resilient Retrieval-Augmented Generation for Edge-Based LLMs](https://arxiv.org/abs/2601.20041)
...
### [33] [Externally Validated Longitudinal GRU Model for Visit-Level 180-Day Mortality Risk in Metastatic Castration-Resistant Prostate Cancer](https://arxiv.org/abs/2601.20046)
...
### [34] [Domain Expansion: A Latent Space Construction Framework for Multi-Task Learning](https://arxiv.org/abs/2601.20069)
...
### [35] [Techno-economic optimization of a heat-pipe microreactor, part II: multi-objective optimization analysis](https://arxiv.org/abs/2601.20079)
...
### [36] [Quantization-Aware Distillation for NVFP4 Inference Accuracy Recovery](https://arxiv.org/abs/2601.20088)
...
### [38] [A Reinforcement Learning Based Universal Sequence Design for Polar Codes](https://arxiv.org/abs/2601.20118)
...
### [39] [Going NUTS with ADVI: Exploring various Bayesian Inference techniques with Facebook Prophet](https://arxiv.org/abs/2601.20120)
...
### [40] [Membership Inference Attacks Against Fine-tuned Diffusion Language Models](https://arxiv.org/abs/2601.20125)
...
### [41] [Scaling Next-Brain-Token Prediction for MEG](https://arxiv.org/abs/2601.20138)
*Richard Csaky*
...
### [42] [Spectral Ghost in Representation Learning: from Component Analysis to Self-Supervised Learning](https://arxiv.org/abs/2601.20154)
...
### [43] [PASS: Ambiguity Guided Subsets for Scalable Classical and Quantum Constrained Clustering](https://arxiv.org/abs/2601.20157)
...
### [44] [What's the plan? Metrics for implicit planning in LLMs and their application to rhyme generation and question answering](https://arxiv.org/abs/2601.20164)
...
### [45] [Local Duality for Sparse Support Vector Machines](https://arxiv.org/abs/2601.20170)
...
### [46] [Loss Landscape Geometry and the Learning of Symmetries: Or, What Influence Functions Reveal About Robust Generalization](https://arxiv.org/abs/2601.20172)
...
### [47] [MAPLE: Self-supervised Learning-Enhanced Nonlinear Dimensionality Reduction for Visual Analysis](https://arxiv.org/abs/2601.20173)
...
### [48] [NeuraLSP: An Efficient and Rigorous Neural Left Singular Subspace Preconditioner for Conjugate Gradient Methods](https://arxiv.org/abs/2601.20174)
...
### [49] [Causal-Driven Feature Evaluation for Cross-Domain Image Classification](https://arxiv.org/abs/2601.20176)
*Chen Cheng,Ang Li*
...
### [50] [On the Computational Complexity of Performative Prediction](https://arxiv.org/abs/2601.20180)
...
### [51] [Meta-Cognitive Reinforcement Learning with Self-Doubt and Recovery](https://arxiv.org/abs/2601.20193)
...
### [52] [DeRaDiff: Denoising Time Realignment of Diffusion Models](https://arxiv.org/abs/2601.20198)
...
### [53] [Minimum-Cost Network Flow with Dual Predictions](https://arxiv.org/abs/2601.20203)
...
### [54] [Hyperparameter Transfer with Mixture-of-Expert Layers](https://arxiv.org/abs/2601.20205)
...
### [55] [Spark: Strategic Policy-Aware Exploration via Dynamic Branching for Long-Horizon Agentic Learning](https://arxiv.org/abs/2601.20209)
...
### [57] [Parametric and Generative Forecasts of Day-Ahead Market Curves for Storage Optimization](https://arxiv.org/abs/2601.20226)
...
### [58] [Certificate-Guided Pruning for Stochastic Lipschitz Optimization](https://arxiv.org/abs/2601.20231)
...
### [59] [HE-SNR: Uncovering Latent Logic via Entropy for Guiding Mid-Training on SWE-BENCH](https://arxiv.org/abs/2601.20255)
...
### [61] [Robust SDE Parameter Estimation Under Missing Time Information Setting](https://arxiv.org/abs/2601.20268)
...
### [62] [The Forecast After the Forecast: A Post-Processing Shift in Time Series](https://arxiv.org/abs/2601.20280)
...
### [64] [A Learning-based Framework for Spatial Impulse Response Compensation in 3D Photoacoustic Computed Tomography](https://arxiv.org/abs/2601.20291)
...
### [65] [Cheap2Rich: A Multi-Fidelity Framework for Data Assimilation and System Identification of Multiscale Physics -- Rotating Detonation Engines](https://arxiv.org/abs/2601.20295)
...
### [66] [Truthfulness Despite Weak Supervision: Evaluating and Training LLMs Using Peer Prediction](https://arxiv.org/abs/2601.20299)
...
### [67] [Delayed Feedback Modeling for Post-Click Gross Merchandise Volume Prediction: Benchmark, Insights and Approaches](https://arxiv.org/abs/2601.20307)
...
### [68] [Window-Diffusion: Accelerating Diffusion Language Model Inference with Windowed Token Pruning and Caching](https://arxiv.org/abs/2601.20332)
...
### [69] [TABED: Test-Time Adaptive Ensemble Drafting for Robust Speculative Decoding in LVLMs](https://arxiv.org/abs/2601.20357)
...
### [71] [LLM-AutoDP: Automatic Data Processing via LLM Agents for Model Fine-tuning](https://arxiv.org/abs/2601.20375)
...
### [72] [FedRD: Reducing Divergences for Generalized Federated Learning via Heterogeneity-aware Parameter Guidance](https://arxiv.org/abs/2601.20397)
...
### [73] [ScatterFusion: A Hierarchical Scattering Transform Framework for Enhanced Time Series Forecasting](https://arxiv.org/abs/2601.20401)
*Wei Li*
...
### [74] [AWGformer: Adaptive Wavelet-Guided Transformer for Multi-Resolution Time Series Forecasting](https://arxiv.org/abs/2601.20409)
*Wei Li*
...
### [75] [Concept Component Analysis: A Principled Approach for Concept Extraction in LLMs](https://arxiv.org/abs/2601.20420)
...
### [76] [Nonlinear Dimensionality Reduction with Diffusion Maps in Practice](https://arxiv.org/abs/2601.20428)
...
### [78] [Fair Recourse for All: Ensuring Individual and Group Fairness in Counterfactual Explanations](https://arxiv.org/abs/2601.20449)
...
### [79] [Implicit Hypothesis Testing and Divergence Preservation in Neural Network Representations](https://arxiv.org/abs/2601.20477)
...
### [80] [An explainable framework for the relationship between dementia and glucose metabolism patterns](https://arxiv.org/abs/2601.20480)
...
### [81] [CCMamba: Selective State-Space Models for Higher-Order Graph Learning on Combinatorial Complexes](https://arxiv.org/abs/2601.20518)
...
### [82] [Unsupervised Ensemble Learning Through Deep Energy-based Models](https://arxiv.org/abs/2601.20556)
...
### [83] [Reinforcement Unlearning via Group Relative Policy Optimization](https://arxiv.org/abs/2601.20568)
...
### [84] [Ranking-aware Reinforcement Learning for Ordinal Ranking](https://arxiv.org/abs/2601.20585)
...
### [85] [Regularized Gradient Temporal-Difference Learning](https://arxiv.org/abs/2601.20599)
...
### [86] [CoBA: Integrated Deep Learning Model for Reliable Low-Altitude UAV Classification in mmWave Radio Networks](https://arxiv.org/abs/2601.20605)
...
### [87] [WFR-MFM: One-Step Inference for Dynamic Unbalanced Optimal Transport](https://arxiv.org/abs/2601.20606)
...
### [92] [Detecting and Mitigating Memorization in Diffusion Models through Anisotropy of the Log-Probability](https://arxiv.org/abs/2601.20642)
...
### [93] [Learning Contextual Runtime Monitors for Safe AI-Based Autonomy](https://arxiv.org/abs/2601.20666)
...
### [98] [Structurally Human, Semantically Biased: Detecting LLM-Generated References with Embeddings and GNNs](https://arxiv.org/abs/2601.20704)
...
### [99] [Adapting the Behavior of Reinforcement Learning Agents to Changing Action Spaces and Reward Functions](https://arxiv.org/abs/2601.20714)
...
### [100] [Deep Semi-Supervised Survival Analysis for Predicting Cancer Prognosis](https://arxiv.org/abs/2601.20729)
...
### [101] [Continual GUI Agents](https://arxiv.org/abs/2601.20732)
...
### [102] [HESTIA: A Hessian-Guided Differentiable Quantization-Aware Training Framework for Extremely Low-Bit LLMs](https://arxiv.org/abs/2601.20745)
...
### [103] [GraphAllocBench: A Flexible Benchmark for Preference-Conditioned Multi-Objective Policy Learning](https://arxiv.org/abs/2601.20753)
...
### [106] [COMET-SG1: Lightweight Autoregressive Regressor for Edge and Embedded AI](https://arxiv.org/abs/2601.20772)
*Shakhyar Gogoi*
...
### [107] [Smoothing the Black-Box: Signed-Distance Supervision for Black-Box Model Copying](https://arxiv.org/abs/2601.20773)
...
### [108] [When More Data Doesn't Help: Limits of Adaptation in Multitask Learning](https://arxiv.org/abs/2601.20774)
...
### [109] [Active Learning for Decision Trees with Provable Guarantees](https://arxiv.org/abs/2601.20775)
...
### [110] [Conditional PED-ANOVA: Hyperparameter Importance in Hierarchical & Dynamic Search Spaces](https://arxiv.org/abs/2601.20800)
...
### [111] [Reinforcement Learning via Self-Distillation](https://arxiv.org/abs/2601.20802)
...
### [112] [GNN Explanations that do not Explain and How to find Them](https://arxiv.org/abs/2601.20815)
...
### [113] [Training Reasoning Models on Saturated Problems via Failure-Prefix Conditioning](https://arxiv.org/abs/2601.20829)
...
### [114] [Reward Models Inherit Value Biases from Pretraining](https://arxiv.org/abs/2601.20838)
...
### [115] [$\mathbb{R}^{2k}$ is Theoretically Large Enough for Embedding-based Top-$k$ Retrieval](https://arxiv.org/abs/2601.20844)
...
### [117] [Post-Training Fairness Control: A Single-Train Framework for Dynamic Fairness in Recommendation](https://arxiv.org/abs/2601.20848)
...
### [118] [Exploring Transformer Placement in Variational Autoencoders for Tabular Data Generation](https://arxiv.org/abs/2601.20854)
...
### [119] [Evolutionary Strategies lead to Catastrophic Forgetting in LLMs](https://arxiv.org/abs/2601.20861)
